...
(function ($) {
				...
				var loadOptions = {
				   ...
				   //     contentType: "application/json; charset=utf-8",
					...
					if ($('#MENUITEM_PORTAL').length == 0) {
						this.load("services/rolesLookUpApi/Portal", loadOptions).then(		
							function (data) {
							...
							this.render('static/RolesApp/templates/RoleEntry.hbs', workingData, '', {
								...
								var roleAppPanel = $(Portals.elem.rolesapp);
								...
								RolesApp.trigger('portalServiceInit');
						...
						this.render(viewName, workingData, '', {
							...
							$.unblockUI();
							var assetPanel = $(Portals.elem.assetPanel);
	...
	RolesApp.bind('renderPortals', Portals.render);	
