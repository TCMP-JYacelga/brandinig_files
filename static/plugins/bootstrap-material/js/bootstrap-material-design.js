(function (global, factory) {
  ...
  Popper$1 = Popper$1 && Object.prototype.hasOwnProperty.call(Popper$1, 'default') ? Popper$1['default'] : Popper$1;
  ...
  class Modal {
    ...
    _triggerBackdropTransition() {
      if (this._config.backdrop === 'static') {
        const hideEventPrevented = $.Event(Event$4.HIDE_PREVENTED);
        ...
        $(this._element).one(Util.TRANSITION_END, () => {
          this._element.classList.remove(ClassName$4.STATIC);
        })
    ...
    _showElement(relatedTarget) {
      const transition = $(this._element).hasClass(ClassName$4.FADE);
      const modalBody = this._dialog ? this._dialog.querySelector(Selector$4.MODAL_BODY) : null;
