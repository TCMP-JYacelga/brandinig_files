...
Ext.define('Ext.toolbar.Paging', {
     ...
     */
    displayMsg : getLabel('lblPgDisplaying', 'Displaying') + ' {0} - {1} ' + getLabel('lblPgOf', 'of') + ' {2}',
    //</locale>
     ...
     */
    emptyMsg : getLabel('lblPgNoDataToDisplay', 'No data to display'),
    //</locale>
     ...
     */
    beforePageText : getLabel('lblPgPage', 'Page'),
    //</locale>
     ...
     */
    afterPageText : getLabel('lblPgOf', 'of') + ' {0}',
    //</locale>
     ...
     */
    firstText : getLabel('lblPgFPage', 'First Page'),
    //</locale>
     ...
     * **Note**: quick tips must be initialized for the quicktip to show.
     */
    prevText : getLabel('lblPgPPage', 'Previous Page'),
    //</locale>
     ...
     * **Note**: quick tips must be initialized for the quicktip to show.
     */
    nextText : getLabel('lblPgNPage', 'Next Page'),
    //</locale>
     ...
     * **Note**: quick tips must be initialized for the quicktip to show.
     */
    lastText : getLabel('lblPgLPage', 'Last Page'),
    //</locale>
     ...
     * **Note**: quick tips must be initialized for the quicktip to show.
     */
    refreshText : getLabel('lblPgRefresh', 'Refresh'),
    //</locale>
