Ext.define('Ext.ux.gcp.FilterPopUpView', {
 extend : 'Ext.window.Window',
	xtype : 'filterPopUpView',
    autoHeight : true,
	 closeAction:'distroy',
	 modal : true,
...
setDataForFilter:function(filterPopUpView){
  ...
  addSelected : function(row, record, index, eopts) {
				var me = this;
				var usermstselectpopup = me.up("filterPopUpView");
...
handleLoadGridData : function(grid, url, pgSize, newPgNo, oldPgNo,
					sorter) {
				var me = this;
				var popObj=grid.up('filterPopUpView');
...
var selectpopup = grid.up("filterPopUpView");
...
updateSelection : function(grid, responseData, args) {
			...
			me.fireEvent('selectionUpdated',me);
			var filterContainer = selectpopup.down('container[itemId="filterContainer"] AutoCompleter');
