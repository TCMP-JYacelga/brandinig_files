Ext.define('GCP.view.ClearingLocationHistoryPopup', {
	...
	initComponent : function() {
		var me = this;
		var partnerBankLbl = getLabel('description', 'Location Description');
		var histTitle = getLabel('clrLocHist', 'Clearing Location History');
	...
	loadHistoryData : function(historyUrl, id) {
		...
		Ext.Ajax.request({
			url : 'cpon/common/history.json?' + csrfTokenName + '=' + csrfTokenValue
				+ '&$histSeekPageId=history.seek.clearinglocationmst',
			method : 'POST',
