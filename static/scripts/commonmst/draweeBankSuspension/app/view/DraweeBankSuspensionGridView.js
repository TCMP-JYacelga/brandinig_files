Ext.define('GCP.view.DraweeBankSuspensionGridView', {
    extend : 'Ext.panel.Panel',
    requires : ['Ext.ux.gcp.SmartGrid','GCP.view.DraweeBankSuspensionActionBarView','Ext.panel.Panel'],
    xtype : 'draweeBankSuspensionGridView',
    width : '100%',
    cls: 'ux_extralargemargin-top',
    initComponent : function() {
        var me = this;
        var actionBar = Ext.create('GCP.view.DraweeBankSuspensionActionBarView', {
                    itemId : 'draweeBankSuspensionActionBarView',
                    height : 21,
                    width : '100%',
        ...
        me.items = [{
            ...
            width : '100%',
            collapsible : true,    
            title : getLabel('summary', 'Drawee Bank Suspension List'),
            autoHeight : true,
