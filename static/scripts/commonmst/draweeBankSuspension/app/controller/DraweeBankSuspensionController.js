Ext.define('GCP.controller.DraweeBankSuspensionController', {
    extend : 'Ext.app.Controller',
    requires : ['Ext.util.Point'],
    views : ['GCP.view.DraweeBankSuspensionView','GCP.view.DraweeBankSuspensionFilterView','GCP.view.DraweeBankSuspensionGridView',
             'GCP.view.DraweeBankSuspensionActionBarView','GCP.view.DraweeBankSuspensionHistoryPopup'],
    refs : [{
            ref : 'view',
            selector : 'draweeBankSuspensionView'
        },{
            ref : 'createNewToolBar',
            selector : 'draweeBankSuspensionView draweeBankSuspensionGridView toolbar[itemId="btnCreateNewToolBar"]'
        },{
            ref : 'filterView',
            selector : 'draweeBankSuspensionView draweeBankSuspensionFilterView'
        },{
            ref : 'gridHeader',
            selector : 'draweeBankSuspensionView draweeBankSuspensionGridView panel[itemId="gridDtlView"] container[itemId="gridHeader"]'
        },{
            ref : 'gridView',
            selector : 'draweeBankSuspensionView draweeBankSuspensionGridView grid[itemId="gridViewMstId"]'
        },{
            ref : 'gridDtlView',
            selector : 'draweeBankSuspensionView draweeBankSuspensionGridView panel[itemId="gridDtlView"]'
        },{
            ref : 'grid',
            selector : 'draweeBankSuspensionGridView smartgrid'
        },{
            ref : 'groupActionBar',
            selector : 'draweeBankSuspensionView draweeBankSuspensionGridView draweeBankSuspensionActionBarView'
        },{
            ref : 'specificFilterPanel',
            selector : 'draweeBankSuspensionView draweeBankSuspensionFilterView panel container[itemId="specificFilter"]'
        },{
            ref : "draweeBankSuspensionFilter",
            selector : 'draweeBankSuspensionView draweeBankSuspensionFilterView textfield[itemId="draweeBankSuspensionFilter"]'
        },{
            ref : "sellerCombo",
            selector : 'draweeBankSuspensionView draweeBankSuspensionFilterView combobox[itemId="sellerCombo"]'
        },{
            ref : "statusFilter",
            selector : 'draweeBankSuspensionView draweeBankSuspensionFilterView combobox[itemId="statusFilter"]'
        }],
    config : {
        filterData : [],
        strProxyUrl : 'services/draweeBankSuspensionMst.json',
        strBatchActionUrl : 'services/draweeBankSuspensionMst/{0}.srvc',
        strAddUrl: 'addDraweeBankSuspensionMst.form',
        strEditUrl: 'editDraweeBankSuspensionMst.form',
        strViewUrl: 'viewDraweeBankSuspensionMst.form',
        draweeBankSuspensionSelected : false
    },
    init : function() {
        var me = this;
        me.control({
            'draweeBankSuspensionView draweeBankSuspensionFilterView' : {
                render : function() {
                    me.setInfoTooltip();
            ...
            'draweeBankSuspensionView draweeBankSuspensionGridView panel[itemId="gridDtlView"]' : {
                render : function() {
                    me.handleGridHeader();
                }
            },
            'draweeBankSuspensionGridView' : {
                render : function(panel) {
                    me.handleSmartGridConfig();
                }
            },
            'draweeBankSuspensionGridView smartgrid' : {
            ...
            'draweeBankSuspensionGridView toolbar[itemId=draweeBankSuspensionActionBarView]' : {
                performGroupAction : function(btn, opts) {
                    me.handleGroupActions(btn);
                }
            },
            'draweeBankSuspensionView draweeBankSuspensionFilterView button[itemId="btnFilter"]' : {
                click : function(btn, opts) {
                    me.setDataForFilter();
                    me.applyFilter();
                }
            },
            'draweeBankSuspensionView draweeBankSuspensionGridView toolbar[itemId="btnCreateNewToolBar"] button[itemId="btnCreateNew"]' : {
                click : function() {
        ...
        Ext.create('Ext.tip.ToolTip', {
            ...
            listeners : {
                beforeshow : function(tip) {
                    ...
                    var draweeBankSuspensionFilter=me.getDraweeBankSuspensionFilter();
                    ...
                    if (!Ext.isEmpty(draweeBankSuspensionFilter)
                            && !Ext.isEmpty(draweeBankSuspensionFilter.getValue()))
                        clrLocName = draweeBankSuspensionFilter.getRawValue();
                    else
    ...
    handleSpecificFilter : function() {
        ...
        var draweeBankSuspensionAuto = Ext.create('Ext.ux.gcp.AutoCompleter', {
            fieldCls : 'xn-form-text w165 xn-suggestion-box ux_font-size14-normal',
            cls:'ux_font-size14-normal',
            name : 'draweeBankSuspension',
            itemId : 'draweeBankSuspensionFilter',
            cfgUrl : 'services/userseek/{0}.json',
            cfgProxyMethodType : 'POST',
            cfgQueryParamName : '$autofilter',
            cfgRecordCount : -1,
            matchFieldWidth:true,
            cfgSeekId : 'draweeBankSuspensionFilter',
            ...
            listeners:{
                'select' : function(combo, record) {
                    me.draweeBankSuspensionSelected = true;
                },
                'change' : function(combo, record) {
                     me.draweeBankSuspensionSelected = false;
                }
            }
        });
        ...
        var sellerComboField = Ext.create('Ext.form.field.ComboBox', {
            ...
            listeners : {
                'render' : function(combo, record) {
                    ...
                    var draweeBankSuspensionAutoCompleter = me.getDraweeBankSuspensionFilter();
                    draweeBankSuspensionAutoCompleter.reset();
                },
                'change' : function(combo, record) {
    ...
    setDataForFilter : function() {
        var me = this;
        var sellerValue = null, draweeBankSuspensionVal = null, draweeBankSuspensionRawVal = null, statusVal = null;
        var jsonArray = [];
        var isPending = true;
        ...
        if(!Ext.isEmpty(filterView)){
            ...
            if(!Ext.isEmpty(draweeBankSuspensionFilter)){
                if(me.draweeBankSuspensionSelected === true){
                    draweeBankSuspensionVal = draweeBankSuspensionFilter.getValue();
                } else {
                    draweeBankSuspensionRawVal = draweeBankSuspensionFilter.getValue();
                }
            }
            ...
            if (!Ext.isEmpty(draweeBankSuspensionVal)) {
                jsonArray.push({
                    paramName : 'draweeBankCode',
                    paramValue1 : encodeURIComponent(draweeBankSuspensionVal.replace(new RegExp("'", 'g'), "\''")),
                    operatorValue : 'eq',
                    dataType : 'S'
                });
            }
        }
        if (!Ext.isEmpty(draweeBankSuspensionRawVal)) {
            jsonArray.push({
                paramName : 'draweeBankDesc',
                paramValue1 : encodeURIComponent(draweeBankSuspensionRawVal.toUpperCase().replace(new RegExp("'", 'g'), "\''")),
                operatorValue : 'lk',
                dataType : 'S'
            });
        }
    ...
    handleGridHeader : function() {
        ...
        if(ACCESSNEW){
            ...
            createNewPanel.add({
                xtype : 'button',
                border : 0,
                text : getLabel('actionCreateNew', 'Suspend Drawee Bank'),
    ...
    getSmartGridConfig : function(){
        ...
        objWidthMap = {
                "draweeBankDesc" : 250,
                "suspensionRemarks" :380,
                "disableFlag" :150,
                "requestStateDesc" : 165
            };
            ...
            arrColsPref = [{
                ...
                "colId" : "suspensionRemarks",
                "colDesc" : getLabel("suspensionRemarks","Suspension Remarks")
            },
            {
                "colId" : "disableFlag",
                "colDesc" : getLabel("disableFlag","Disable Accross Locations")
            },{
                "colId" : "requestStateDesc",
                "colDesc" : getLabel("status","Status")
            }];
            storeModel = {
                    fields : ['draweeBankDesc','disableFlag','suspensionRemarks','primaryKey','history','identifier','makerId','sellerId','validFlag',
                             'requestStateDesc', 'parentRecordKey','version','isSubmitted','recordKeyNo','masterRecordkeyNo', 
                             '__metadata'],
    ...
    handleRowIconClick : function(tableView, rowIndex, columnIndex, btn, event, record) {
        ...
        if (actionName === 'submit' || actionName === 'accept'
            ...
            if (!Ext.isEmpty(recHistory)&& !Ext.isEmpty(recHistory.__deferred.uri)) {
                me.showHistory(record.get('history').__deferred.uri, record.get('identifier'), record.get('draweeBankDesc'));
            }
   ...
   createFormField : function(element, type, name, value) {
    ...
    showHistory : function(url, id, desc) {
        Ext.create('GCP.view.DraweeBankSuspensionHistoryPopup', {
                    historyUrl : url,
                    identifier : id,
                    description : desc
                }).show();
    ...
    columnRenderer : function(value, meta, record, rowIndex, colIndex, store,
        ...
        {
        	if(colId === 'col_disableFlag')
        	{
    			if(strRetVal == 'Y')
    			{
    				strRetVal = getLabel('yes','Yes');
    			}
    			else if(strRetVal == 'N')
    			{
    				strRetVal = getLabel('no','No');
    			}
    		}
