Ext.define('GCP.view.BankProductGridView', {
	...
	initComponent : function() {
		var me = this;
		var actionBar = Ext.create('GCP.view.BankProductActionBarView', {
		...
		me.items = [{
			...
			collapsible: true,
			title: getLabel('bankProductTitle', 'Bank Product List'),
			autoHeight : true,
			itemId : 'bankProductDtlView',
			items : [{
					xtype : 'container',
					layout : 'hbox',
