...
Ext.define('GCP.view.HistoryPopup', {
	...
	initComponent : function() {
		...
		var productlabel = getLabel('prfDesc', 'Profile Description');
		var histTitle = getLabel('interestProfileHist', 'Interest Profile History');
	...
	loadHistoryData : function(historyUrl, id) {
		...
		Ext.Ajax.request({
		//	url : historyUrl,
			url : 'services/common/history.json' + '?&' + '$histSeekPageId=history.seek.interestProfile',
