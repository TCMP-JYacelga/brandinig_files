...
Ext.define( 'GCP.view.BankAdminOnBehalfPrivilegeView',
{
	extend : 'Ext.panel.Panel',
	xtype : 'bankAdminOnBehalfPrivilegeViewPopupType',
	width : 700,
	height : 400,
	//title : 'On Behalf Privileges',
	//layout : 'fit',
//	overflowY : 'auto',
	config :
	{
	...
	/*loadFeaturs : function( accessType, moduleCode, accessTypeCode,menuMode  )
	{
			var featureData;
       var objParam = {}, arrMatches, strRegex = /[?&]([^=#]+)=([^&#]*)/g;
