 ...
 */
Ext.define( 'GCP.view.BankAdminCategoryHistoryView',
{
...
config : {
	...
	{
		var rolelabel = getLabel('lbl.bankAdminCategory.categoryDesc', 'Role Name');
		var thisClass = this;
	...
	loadHistoryData : function( historyUrl, id )
	{
		...
		Ext.Ajax.request(
		{
			url : 'services/common/history.json' + '?&' + '$histSeekPageId=history.seek.bankAdminCategoryList',
			method : 'POST',
