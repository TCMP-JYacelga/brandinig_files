...
Ext.define('GCP.view.HistoryPopup', {
	...
	initComponent : function() {
		...
		var productlabel = getLabel('taxRateName', 'Tax Rate');
		var histTitle = getLabel('taxRateSummaryHist', 'Tax Rate Summary History');
	...
	loadHistoryData : function(historyUrl, id) {
		...
		Ext.Ajax.request({
			//url : historyUrl,
			url : 'cpon/common/history.json' + '?&' + '$histSeekPageId=history.seek.serviceTaxRate',
			method : 'POST',
