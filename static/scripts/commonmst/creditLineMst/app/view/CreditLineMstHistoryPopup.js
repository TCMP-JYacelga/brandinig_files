Ext.define('GCP.view.CreditLineMstHistoryPopup', {
	...
	initComponent : function() {
		var me = this;
		var lineCodeLbl = getLabel('lineCode', 'Line Code');
		var histTitle = getLabel('lineHist', 'Credit Lines History');
	...
	loadHistoryData : function(historyUrl, id) {
		...
		Ext.Ajax.request({
			url : 'cpon/common/history.json?' + csrfTokenName + '=' + csrfTokenValue
				+ '&$histSeekPageId=history.seek.creditlines',
			method : 'POST',
