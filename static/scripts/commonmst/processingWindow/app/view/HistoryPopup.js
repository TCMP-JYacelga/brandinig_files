...
Ext.define('GCP.view.HistoryPopup', {
	...
	initComponent : function() {
		...
		var sellerLabel = getLabel('seller', 'Seller');
		var histTitle = getLabel('processWindowHistory', 'Processing Window History');
	...
	loadHistoryData : function(historyUrl, id) {
		...
		Ext.Ajax.request({
			//url : historyUrl,
			url : 'cpon/common/history.json' + '?&' + '$histSeekPageId=history.seek.processWindow',
			method : 'POST',
