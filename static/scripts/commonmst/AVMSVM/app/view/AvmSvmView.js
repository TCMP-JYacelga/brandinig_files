Ext.define('GCP.view.AvmSvmView', {
	...
	xtype : 'avmSvmView',
	requires : ['Ext.container.Container', 'GCP.view.AvmSvmTitleView',
			'GCP.view.AvmSvmFilterView', 'GCP.view.AvmSvmGridView'],
	width : '100%',
	autoHeight : true,
	minHeight : 600,
	...
	createGroupView:function(){
		...
		groupView = Ext.create('Ext.ux.gcp.GroupView', {
			...
			cfgGroupByUrl : 'services/grouptype/approvalMatrix/groupBy.json?$filterscreen=groupViewFilter',
			cfgSummaryLabel : 'Matrix List',
