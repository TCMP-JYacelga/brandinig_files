Ext.define('GCP.view.ClientOfficeGridView', {
	extend : 'Ext.panel.Panel',
	requires : ['Ext.ux.gcp.SmartGrid','GCP.view.ClientOfficeActionBarView','Ext.panel.Panel'],
	xtype : 'clientOfficeGridView',
	width : '100%',
    cls: 'ux_extralargemargin-top',
	initComponent : function() {
		var me = this;
		var actionBar = Ext.create('GCP.view.ClientOfficeActionBarView', {
		...
		this.items = [{
			...
			width : '100%',
			collapsible : true,	
			title : getLabel('clientOfficeList', 'Client Offices'),
			autoHeight : true,
