Ext.define('GCP.view.DrawerSetupGridView', {
	extend : 'Ext.panel.Panel',
	requires : ['Ext.ux.gcp.SmartGrid','GCP.view.DrawerGroupActionBarView','Ext.panel.Panel'],
	xtype : 'drawerSetupGridView',
	width : '100%',
	cls:'xn-ribbon',
	initComponent : function() {
		var me = this;
		var actionBar = Ext.create('GCP.view.DrawerGroupActionBarView', {
		...
		this.items = [{
			...
			width : '100%',
			collapsible : true,	
			title : getLabel('drawerList', 'Payer List'),
			autoHeight : true,
