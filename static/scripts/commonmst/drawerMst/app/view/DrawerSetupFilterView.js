Ext.define('GCP.view.DrawerSetupFilterView', {
			...
			initComponent : function() {
				...
				var drawerTextfield = {
						...
						items : [{
							xtype : 'label',
							text : getLabel('drawerName', 'Payer Name'),
							padding : '1 0 0 10',
							...
							width : 200,
							name : 'drawerName',
							itemId : 'drawerNameFltId',
							cfgUrl : 'services/drawerseek/{0}.json',
							cfgQueryParamName : 'qfilter',
							cfgRecordCount : -1,
							cfgSeekId : 'drawerNameSeek',
				...
				filterContainerArr.push(drawerTextfield);
