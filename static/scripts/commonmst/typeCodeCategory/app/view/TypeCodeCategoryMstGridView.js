Ext.define('GCP.view.TypeCodeCategoryMstGridView', {
	...
	initComponent : function() {
		var me = this;
		var actionBar = Ext.create('GCP.view.TypeCodeCategoryMstActionBarView', {
		...
		me.items = [{
			...
			collapsible: true,
			title: getLabel('tpcmstTypeCodeCategoryID', 'Type Code Category'),
			autoHeight : true,
			itemId : 'typeCodeDtlView',
			items : [{
					xtype : 'container',
					layout : 'hbox',
