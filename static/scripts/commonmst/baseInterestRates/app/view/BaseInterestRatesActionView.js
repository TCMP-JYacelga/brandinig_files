Ext.define('GCP.view.BaseInterestRatesActionView', {
	extend : 'Ext.toolbar.Toolbar',
	xtype : 'baseInterestRatesActionView',
	enableOverflow : true,
	border : false,
	...
	initComponent : function() {
		var me = this;
		me.items = [ {
			text : getLabel('prfMstActionSave', 'Save'),
			disabled : true,
			actionName : 'save',
			maskPosition : 1,
			...
			text : getLabel('prfMstActionUpdateSubmit', 'Submit'),
			disabled : true,
			actionName : 'submit',
			maskPosition : 1,
			handler : function(btn, opts) {
