Ext.define('GCP.view.ForecastPackageView', {
	extend : 'Ext.container.Container',
	xtype : 'forecastPackageView',
	requires : ['Ext.container.Container','Ext.ux.gcp.GroupView', 'GCP.view.ForecastPackageFilterView'],
	...
	createGroupView : function() {
		...
		if (objForecastPackagePref) {
			var objJsonData = Ext.decode(objForecastPackagePref);
		...
		groupView = Ext.create('Ext.ux.gcp.GroupView', {
			cfgGroupByUrl : 'services/grouptype/forecastPackageMst/groupBy.json?$filterGridId=GRD_CFF_FORECASTPKG',
			...
			cfgGridModel : {
				...
				storeModel : {
					fields : ['clientName','mypDescription','isSubmitted', 'requestStateDesc', 'mypAllowRepetitive',
							  'validFlag', 'requestState','makerId', '__metadata', 'history', 'isRecurring',
							  'identifier','makerStamp','checkerStamp','checkerId'],
					proxyUrl : 'services/cffPackageMstList.json',
					rootNode : 'd.profile',
					totalRowsNode : 'd.__count'
				},
				groupActionModel : me.getGroupActionModel(),
				defaultColumnModel : me.getColumnModel(FORECAST_PACKAGE_COLUMNS),
	...
	columnRenderer : function(value, meta, record, rowIndex, colIndex, store,
			view, colId) {
		var strRetValue;
		if(colId == 'col_mypAllowRepetitive'){
			if(record.data.mypAllowRepetitive == 'Y')
				value = "Yes";
			else
				value = "No";
		}
