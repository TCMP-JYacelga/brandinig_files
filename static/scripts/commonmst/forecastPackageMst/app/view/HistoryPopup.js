...
Ext.define('GCP.view.HistoryPopup', {
	...
	initComponent : function() {
		...
		var histTitle = getLabel('forecastHistTitle', 'Forecast Package History');
		...
		if (Ext.isEmpty(this.historyUrl)) {
			...
			var arrayData = thisClass.loadHistoryData(this.historyUrl, this.identifier,this.primaryFieldName,this.moduleCode);
	...
	loadHistoryData : function(historyUrl, id,primaryFieldName,moduleCode) {
		var me = this;
		var arrayData = new Array();
		Ext.Ajax.request({
			
			//url : historyUrl,
			url : 'services/common/history.json' + '?&' + '$histSeekPageId=history.seek.cffPackage' + '&$screenWeight='+intWeight
			+ '&$primaryFieldName='+primaryFieldName + '&$moduleCode='+moduleCode ,
			method : 'POST',
