...
var objIntrefacePrivilegePopup = null;
...
Ext.application({
	...
	//	appFolder : 'app',
	requires : [ 'GCP.view.OthersView', 'GCP.view.BankReportsGridView','GCP.view.UserMstSelectPopup', 'Ext.window.MessageBox','GCP.view.BankReportsGridView','GCP.view.OthersView','GCP.view.AdminPriviligesPopup','Ext.util.MixedCollection','Ext.util.Filter','GCP.view.PayPriviligesPopup','GCP.view.ColPriviligesPopup','Ext.form.field.Checkbox','GCP.view.BRPriviligesPopup' ,'GCP.view.PortalPriviligesPopup',
	'GCP.view.TradePriviligesPopup','GCP.view.ForecastPriviligesPopup','GCP.view.LoanPriviligesPopup','GCP.view.DepositPriviligesPopup','GCP.view.InvestmentPriviligesPopup','GCP.view.PositivePayPriviligesPopup','GCP.view.PositivePayGranularPriviligesPopup','GCP.view.CheckPriviligesPopup','GCP.view.CheckGranularPriviligesPopup','GCP.view.IncomingAchPriviligesPopup','GCP.view.BrGranularPriviligesPopup','GCP.view.SIGranularPriviligesPopup','GCP.view.ReversalPayGranularPriviligesPopup','GCP.view.PaymentGranularPriviligesPopup','GCP.view.TemplatesGranularPriviligesPopup','GCP.view.CategoryInterfacePrivilegePopup'],
	controllers : [ 'GCP.controller.OthersController', 'GCP.controller.BankReportsController','GCP.controller.PrivilegeController','GCP.controller.SubsidiaryController', 'GCP.controller.InterfaceController', 'GCP.controller.SelectPopupController',
					'GCP.controller.LoansController','GCP.controller.DepositController','GCP.controller.InvestmentController','GCP.controller.PositivePayController','GCP.controller.GranularPositivePayController','GCP.controller.CheckController','GCP.controller.IncomingAchController','GCP.controller.CheckGranularPrivilegePayController','GCP.controller.BrGranularPrivilegePayController','GCP.controller.PaymentGranularPermissionsController' ],
	launch : function() {
...
//							title : getLabel("brfeatureProfile", "BR Feature")
	...
	if(isPaymentGrnularEnable == true){
			...
			objReversalPayGranularPrivPriviligePopup.center();			
			...
			objSIGranularPrivPriviligePopup.center();
						...
						objPayGranularPrivPriviligePopup.center();
						...
						objTemplatesGranularPrivPriviligePopup.center();
...
function getBrGranularPrivilegesPopup() {
 if (null != objBrGranularPrivPriviligePopup) {
...
function getPortalPrivilegesPopup() {
	if($('#chkallPrivilagesSelectedFlag').attr('src')=='static/images/icons/icon_checked.gif')
  {
   ...
   objPortalPriviligePopup.center();
  }
  else
  {
