...
Ext.application({
			...
			requires : ['GCP.view.LiquidityPriviligesPopup','GCP.view.LiquidityPriviligesPopup','GCP.view.UserMstSelectPopup','Ext.util.MixedCollection','Ext.util.Filter','Ext.window.MessageBox'],
			launch : function() {
