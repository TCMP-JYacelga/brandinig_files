Ext.define('GCP.controller.CheckController',{
	...
	init : function() {
		...
		me.control({
						...
						'checkPriviligesPopup container panel panel[id="checkHeader"] checkbox[itemId="checkHeader_viewIcon"]' : {
							change : me.toggleCheckUncheck
							},
						'checkPriviligesPopup container panel panel[id="checkHeader"] checkbox[itemId="checkHeader_editIcon"]' : {
							change : me.toggleCheckUncheck
							},
						'checkPriviligesPopup container panel panel[id="checkHeader"] checkbox[itemId="checkHeader_authIcon"]' : {
							change : me.toggleCheckUncheck
							}
