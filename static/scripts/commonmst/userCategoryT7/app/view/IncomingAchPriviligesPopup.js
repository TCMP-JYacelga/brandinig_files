var fieldJson = [];
Ext.define('GCP.view.IncomingAchPriviligesPopup', {
	extend: 'Ext.window.Window',
	requires : ['Ext.toolbar.Spacer'],
	xtype: 'incomingAchPriviligesPopup',
	width : 700,
	height : 250,
	cls : 't7-grid',
	title: getLabel('incomingAchPrivileges', 'Incoming ACH Privileges'),
	config: {
		resizable:true,
		modal : true,
		draggable : true,
	...
	var me = this;
		if(mode === "VIEW"){
				Ext.Ajax.request({
					...
					method : 'POST',
					async: false,
					params : { module: '11',categoryId:userCategory},
	...
	setUserIncomingAchRights : function()
	{
		var self = this;
	...
	var thisClass = this;
		thisClass.items = [{
			...
			items:[{
						xtype: 'panel',
						itemId : 'incomingAchColumnHeader',
						layout:'column',
						cls: 'alignCenter',
						margin : '5 5 5 5',
						padding: '5 5 5 5',
						...
						items:[{
								xtype: 'panel',
								itemId : 'incomingAchHeader',
								layout:'column',
								cls:'red-bg',
								margin : '4 0 0 0',
								items: thisClass.setPanelHeader('incomingAchHeader','Incoming ACH')
							},
							{
								xtype: 'panel',
								titleAlign : "left", 
								cls : 'xn-ribbon',
								collapseFirst : true,
								itemId : 'userIncomingAchParametersSection',
								layout:'column',
								items: thisClass.setUserIncomingAchRights()	
