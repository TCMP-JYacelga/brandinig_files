...
Ext.define('GCP.view.HistoryPopup', {
	...
	initComponent : function() {
		...
		var productlabel = getLabel('holidayDesc', 'Holiday Description');
		var histTitle = getLabel('holidaySummaryHist', 'Holiday Summary History');
	...
	loadHistoryData : function(historyUrl, id) {
		...
		Ext.Ajax.request({
			...
			success : function(response) {
				...
				me.productName = data.holidayDescription;
