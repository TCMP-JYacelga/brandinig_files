Ext.define('GCP.view.ProductRuleGridView', {
	extend : 'Ext.panel.Panel',
	requires : ['Ext.ux.gcp.SmartGrid','GCP.view.ProductRuleActionBarView','Ext.panel.Panel'],
	xtype : 'productRuleGridView',
	width : '100%',
    cls: 'ux_extralargemargin-top',
	initComponent : function() {
		var me = this;
		var actionBar = Ext.create('GCP.view.ProductRuleActionBarView', {
					itemId : 'AlertGroupActionBarView_subcriptionDtl',
					height : 21,
					width : '100%',
					cls : 'xn-ribbon ux_header-width',
					parent : me
				});
		this.items = [{
				xtype : 'container',
			...
			width : '100%',
			collapsible : true,	
			title : getLabel('productRuleList', 'Product Rule List'),
			autoHeight : true,
