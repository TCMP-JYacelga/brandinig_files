...
function enableDisabledFields()
{
	...
	$('.frmAmt').removeAttr("disabled");
	$('#sellerCode').removeAttr("disabled");
	$('#interestBasis').removeAttr("disabled");
	$('#ccyCode').removeAttr("disabled");
	$('#setlFreqType').removeAttr("disabled");
	$('#accrualFreqType').removeAttr("disabled");
