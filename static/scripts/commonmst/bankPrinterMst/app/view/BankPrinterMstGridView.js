Ext.define('GCP.view.BankPrinterMstGridView', {
	extend : 'Ext.panel.Panel',
	requires : ['Ext.ux.gcp.SmartGrid','GCP.view.BankPrinterMstActionBarView','Ext.panel.Panel'],
	xtype : 'bankPrinterMstGridView',
	width : '100%',
    cls: 'ux_extralargemargin-top',
	initComponent : function() {
		var me = this;
		var actionBar = Ext.create('GCP.view.BankPrinterMstActionBarView', {
					itemId : 'bankPrinterMstActionBarView',
					height : 21,
					width : '100%',
		...
		me.items = [{
			...
			width : '100%',
			collapsible : true,
			title : getLabel('bankPrinterList', 'Bank Printer List'),
			autoHeight : true,
