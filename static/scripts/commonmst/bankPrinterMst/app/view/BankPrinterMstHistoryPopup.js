Ext.define('GCP.view.BankPrinterMstHistoryPopup', {
	...
	initComponent : function() {
		var me = this;
		var partnerBankLbl = getLabel('mediaDesc', 'Media Description');
		var histTitle = getLabel('bankPrinterHist', 'Bank Printer Master History');
	...
	loadHistoryData : function(historyUrl, id) {
		...
		Ext.Ajax.request({
			url : 'cpon/common/history.json?' + csrfTokenName + '=' + csrfTokenValue
				+ '&$histSeekPageId=history.seek.bankPrinterMst',
			method : 'POST',
