Ext.define('GCP.controller.PrivilegeController',{
	...
	init : function() {
		var me = this;
		me.control({
					'adminPriviligesPopup container panel panel[id="adminHeader"] button[itemId="adminHeader_viewIcon"]' : {
						click : me.toggleCheckUncheck
						},
					'adminPriviligesPopup container panel panel[id="adminHeader"] button[itemId="adminHeader_editIcon"]' : {
						click : me.toggleCheckUncheck
						},
					'adminPriviligesPopup container panel panel[id="adminHeader"] button[itemId="adminHeader_authIcon"]' : {
						click : me.toggleCheckUncheck
						},
					...
					// BR POPUP
					'bRPriviligesPopup container panel panel[id="brHeader"] button[itemId="brHeader_viewIcon"]' : {
						click : me.toggleCheckUncheck
						},
					'bRPriviligesPopup container panel panel[id="brHeader"] button[itemId="brHeader_editIcon"]' : {
						click : me.toggleCheckUncheck
						},
					'bRPriviligesPopup container panel panel[id="brHeader"] button[itemId="brHeader_authIcon"]' : {
						click : me.toggleCheckUncheck
						},
					...
					'bRPriviligesPopup container panel panel[id="incomingWireHeader"] button[itemId="incomingWireHeader_authIcon"]' : {
						...
						// Portal POPUP
						'portalPriviligesPopup container panel panel[id="portalSetupHeader"] button[itemId="portalSetupHeader_viewIcon"]' : {
							click : me.toggleCheckUncheck
							},
						'portalPriviligesPopup container panel panel[id="portalSetupHeader"] button[itemId="portalSetupHeader_editIcon"]' : {
							click : me.toggleCheckUncheck
							},
						'portalPriviligesPopup container panel panel[id="portalSetupHeader"] button[itemId="portalSetupHeader_authIcon"]' : {
							click : me.toggleCheckUncheck
							},
					...
					// PAYMENT POPUP
					'payPriviligesPopup container panel panel[id="paySetupHeader"] button[itemId="paySetupHeader_viewIcon"]' : {
						click : me.toggleCheckUncheck
						},
					'payPriviligesPopup container panel panel[id="paySetupHeader"] button[itemId="paySetupHeader_editIcon"]' : {
						click : me.toggleCheckUncheck
						},
					'payPriviligesPopup container panel panel[id="paySetupHeader"] button[itemId="paySetupHeader_authIcon"]' : {
						click : me.toggleCheckUncheck
						},
						
					'payPriviligesPopup container panel panel[id="txnHeader"] button[itemId="txnHeader_viewIcon"]' : {
						click : me.toggleCheckUncheck
						},
					'payPriviligesPopup container panel panel[id="txnHeader"] button[itemId="txnHeader_editIcon"]' : {
						click : me.toggleCheckUncheck
						},
					'payPriviligesPopup container panel panel[id="txnHeader"] button[itemId="txnHeader_authIcon"]' : {
						click : me.toggleCheckUncheck
						},
					
					'payPriviligesPopup container panel panel[id="fileoptHeader"] button[itemId="fileoptHeader_viewIcon"]' : {
						click : me.toggleCheckUncheck
						},
					'payPriviligesPopup container panel panel[id="fileoptHeader"] button[itemId="fileoptHeader_editIcon"]' : {
						click : me.toggleCheckUncheck
						},
					'payPriviligesPopup container panel panel[id="fileoptHeader"] button[itemId="fileoptHeader_authIcon"]' : {
						click : me.toggleCheckUncheck
						},
					...
					'fscPriviligesPopup container panel panel[id="fscHeader"] button[itemId="fscHeader_viewIcon"]' : {
						click : me.toggleCheckUncheck
						},
					'fscPriviligesPopup container panel panel[id="fscHeader"] button[itemId="fscHeader_editIcon"]' : {
						click : me.toggleCheckUncheck
						},
					'fscPriviligesPopup container panel panel[id="fscHeader"] button[itemId="fscHeader_authIcon"]' : {
						click : me.toggleCheckUncheck
						},
						
						'fscPriviligesPopup container panel panel[id="ftxnsHeader"] button[itemId="ftxnsHeader_viewIcon"]' : {
							click : me.toggleCheckUncheck
							},
						'fscPriviligesPopup container panel panel[id="ftxnsHeader"] button[itemId="ftxnsHeader_editIcon"]' : {
							click : me.toggleCheckUncheck
							},
						'fscPriviligesPopup container panel panel[id="ftxnsHeader"] button[itemId="ftxnsHeader_authIcon"]' : {
							click : me.toggleCheckUncheck
							},
						'fscPriviligesPopup container panel panel[id="flupHeader"] button[itemId="flupHeader_viewIcon"]' : {
							click : me.toggleCheckUncheck
							},
						'fscPriviligesPopup container panel panel[id="flupHeader"] button[itemId="flupHeader_editIcon"]' : {
							click : me.toggleCheckUncheck
							},
						'fscPriviligesPopup container panel panel[id="flupHeader"] button[itemId="flupHeader_authIcon"]' : {
							click : me.toggleCheckUncheck
							},
					'liquidityPriviligesPopup container panel panel[id="lmsHeader"] button[itemId="lmsHeader_viewIcon"]' : {
						click : me.toggleCheckUncheck
						},
					'liquidityPriviligesPopup container panel panel[id="lmsHeader"] button[itemId="lmsHeader_editIcon"]' : {
						click : me.toggleCheckUncheck
						},
					'liquidityPriviligesPopup container panel panel[id="lmsHeader"] button[itemId="lmsHeader_authIcon"]' : {
						click : me.toggleCheckUncheck
						},
				'liquidityPriviligesPopup container panel panel[id="txnsHeader"] button[itemId="txnsHeader_viewIcon"]' : {
					click : me.toggleCheckUncheck
					},
				'liquidityPriviligesPopup container panel panel[id="txnsHeader"] button[itemId="txnsHeader_editIcon"]' : {
					click : me.toggleCheckUncheck
					},
				'liquidityPriviligesPopup container panel panel[id="txnsHeader"] button[itemId="txnsHeader_authIcon"]' : {
					click : me.toggleCheckUncheck
					},
				'liquidityPriviligesPopup container panel panel[id="queryHeader"] button[itemId="queryHeader_viewIcon"]' : {
					click : me.toggleCheckUncheck
					},
				'liquidityPriviligesPopup container panel panel[id="queryHeader"] button[itemId="queryHeader_editIcon"]' : {
					click : me.toggleCheckUncheck
					},
				'liquidityPriviligesPopup container panel panel[id="queryHeader"] button[itemId="queryHeader_authIcon"]' : {
					click : me.toggleCheckUncheck
					},
