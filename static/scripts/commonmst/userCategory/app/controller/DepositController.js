Ext.define('GCP.controller.DepositController',{
	...
	init : function() {
		...
		me.control({
						...
						'depositPriviligesPopup container panel panel[id="depositHeader"] button[itemId="depositHeader_viewIcon"]' : {
							click : me.toggleCheckUncheck
							},
						'depositPriviligesPopup container panel panel[id="depositHeader"] button[itemId="depositHeader_editIcon"]' : {
							click : me.toggleCheckUncheck
							},
						'depositPriviligesPopup container panel panel[id="depositHeader"] button[itemId="depositHeader_authIcon"]' : {
							click : me.toggleCheckUncheck
							}
