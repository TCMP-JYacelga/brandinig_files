			...
			if (Ext.isEmpty(userMstSelectPopup)) {
				...
				var storeModel = {
					fields : ['assigned', 'clientDescription','clientCode','identifier',
							'assignmentStatus', 'adminEnable', 'brEnable', 'bankRepEnable', 'checksEnable','lmsEnable','fscEnable',
							'collectionEnable','forecastEnable','incomingWireEnable', 'paymentEnable', 'positivePayEnable',
