Ext.define('GCP.controller.LoansController',{
	...
	init : function() {
		...
		me.control({
						...
						'loanPriviligesPopup container panel panel[id="loanHeader"] button[itemId="loanHeader_viewIcon"]' : {
							click : me.toggleCheckUncheck
							},
						'loanPriviligesPopup container panel panel[id="loanHeader"] button[itemId="loanHeader_editIcon"]' : {
							click : me.toggleCheckUncheck
							},
						'loanPriviligesPopup container panel panel[id="loanHeader"] button[itemId="loanHeader_authIcon"]' : {
							click : me.toggleCheckUncheck
							}
