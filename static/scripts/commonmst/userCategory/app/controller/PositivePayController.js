Ext.define('GCP.controller.PositivePayController',{
	...
	init : function() {
		...
		me.control({
						...
						'positivePayPriviligesPopup container panel panel[id="positivePayHeader"] button[itemId="positivePayHeader_viewIcon"]' : {
							click : me.toggleCheckUncheck
							},
						'positivePayPriviligesPopup container panel panel[id="positivePayHeader"] button[itemId="positivePayHeader_editIcon"]' : {
							click : me.toggleCheckUncheck
							},
						'positivePayPriviligesPopup container panel panel[id="positivePayHeader"] button[itemId="positivePayHeader_authIcon"]' : {
							click : me.toggleCheckUncheck
							}
