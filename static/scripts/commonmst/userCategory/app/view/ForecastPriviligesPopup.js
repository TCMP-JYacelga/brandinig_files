			...
			items:[{
						...
						},
						{
							...
							items:[{
								...
								cls:'red-bg',
								margin : '4 0 0 0',
								items: thisClass.setPanelHeader('forecastSetupHeader','Forecast Setup')
							},
							{
								xtype: 'panel',
								titleAlign : "left", 
							...
							},
							{
								...
								cls:'red-bg',
								margin : '4 0 0 0',
								items: thisClass.setPanelHeader('forecastTransactionHeader','Forecast Transaction')
							},
							{
								xtype: 'panel',
