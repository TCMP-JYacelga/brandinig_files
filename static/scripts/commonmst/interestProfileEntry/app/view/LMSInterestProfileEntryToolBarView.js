Ext.define( 'GCP.view.LMSInterestProfileEntryToolBarView',
{
	...
	{
		var me = this;
		var isUpdate = (null != recordKeyNo && "" != recordKeyNo) ? true : false;
		this.items =
		[
			
							{
								...
								[
									...
									,'->',
									{
										xtype : 'button',
										itemId : 'btnSave',
										text : (!isUpdate) ? '<i class="fa fa-save ux_icon-padding"></i>'+getLabel('save','Save') : '<i class="fa fa-save ux_icon-padding"></i>'+getLabel('btnUpdate','Update') ,
										cls : 'inline_block ux_button-padding ux_button-background-color',
										parent : this,
