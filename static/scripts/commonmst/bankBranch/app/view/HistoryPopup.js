...
Ext.define('GCP.view.HistoryPopup', {
	...
	initComponent : function() {
		...
		var clientlabel = getLabel('drawerClientName', 'Bank Name');
		var histTitle = getLabel('drawerHist', 'Bank Branch History');
	...
	loadHistoryData : function(historyUrl, id) {
		...
		Ext.Ajax.request({
			//url : historyUrl,
			url : 'cpon/common/history.json' + '?&' + '$histSeekPageId=history.seek.bankBranch',
			method : 'POST',
