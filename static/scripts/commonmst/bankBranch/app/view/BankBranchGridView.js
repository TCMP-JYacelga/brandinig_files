Ext.define('GCP.view.BankBranchGridView', {
	extend : 'Ext.panel.Panel',
	requires : ['Ext.ux.gcp.SmartGrid','GCP.view.BankBranchActionBarView','Ext.panel.Panel'],
	xtype : 'bankBranchGridView',
	width : '100%',
    cls: 'ux_extralargemargin-top',
	initComponent : function() {
		var me = this;
		var actionBar = Ext.create('GCP.view.BankBranchActionBarView', {
		...
		this.items = [{
			...
			width : '100%',
			collapsible : true,	
			title : getLabel('bankList', 'Bank Branch List'),
			autoHeight : true,
