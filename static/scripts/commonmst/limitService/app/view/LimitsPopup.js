Ext.define('GCP.view.LimitsPopup', {
			...
			initComponent : function() {
				...
				var entityType1Store = Ext.create('Ext.data.Store',{
											...
											proxy : {
												type : 'ajax',
												url : 'services/category/entityType1Values?id='+encodeURIComponent(parentkey)+'&entityType1='+me.entity_type1,
												reader : {
													type : 'json'
													//root : 'd.accounts'
												},
				...
				var limitsStore = Ext.create('Ext.data.Store',{
											...
											proxy : {
												type : 'ajax',
												url : 'services/category/limitProfilesList?id='+encodeURIComponent(parentkey),
												reader : {
													type : 'json'
													//root : 'd.accounts'
												},
				...
				adminListView = Ext.create('Ext.ux.gcp.SmartGrid', {
							...
							storeModel : {
								...
								proxyUrl : 'services/category/clientLimitPopupListValues.json',
			...
			handleSaveBtn : function() {
				...
				var jsonData = { identifier : parentkey,
					...
					{
								Ext.Ajax.request({
									url: 'services/category/saveCustomizedPopupValues',
									method: 'POST',
									jsonData: jsonData,
			...
			handleRowIconClick : function(tableView, rowIndex, columnIndex, btn, event, record){
				var me =this;
				var grid = me.down('grid');
				var strUrl="services/category/deleteCustomizedPopupValues";
