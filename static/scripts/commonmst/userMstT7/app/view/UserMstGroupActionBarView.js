/**
 * UserMstGroupActionBarView contains different buttons which are different
 * group actions which user can perform on different records in the grid.These
 * actions are enabled/disabled depending on those mask(bit positions) which is
 * present in response to service.
 */
Ext.define('GCP.view.UserMstGroupActionBarView', {
	extend : 'Ext.toolbar.Toolbar',
	xtype : 'userMstGroupActionBarView',
	enableOverflow : true,
	border : false,
	...
	initComponent : function() {
		...
		{
				text : getLabel( 'userMstActionClear', 'Clear User' ),
				disabled : true,
