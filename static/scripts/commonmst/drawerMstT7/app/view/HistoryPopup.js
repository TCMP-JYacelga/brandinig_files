...
Ext.define('GCP.view.HistoryPopup', {
	...
	initComponent : function() {
		...
		var clientlabel = getLabel('drawerClientName', 'Company Name');
		var histTitle = getLabel('drawerHist', 'Payer History');
	...
	loadHistoryData : function(historyUrl, id) {
		...
		Ext.Ajax.request({
			//url : historyUrl,
			url : 'cpon/common/history.json' + '?&' + '$histSeekPageId=history.seek.drawerMaster',
			method : 'POST',
