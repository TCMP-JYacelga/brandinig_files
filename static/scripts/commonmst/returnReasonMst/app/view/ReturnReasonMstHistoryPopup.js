Ext.define('GCP.view.ReturnReasonMstHistoryPopup', {
    ...
    initComponent : function() {
        var me = this;
        var reasonCodeLbl = getLabel('reasonCode', 'Reason Code');
        var histTitle = getLabel('reasonHist', 'Reason Code History');
    ...
    loadHistoryData : function(historyUrl, id) {
        ...
        Ext.Ajax.request({
            url : 'cpon/common/history.json?$histSeekPageId=history.seek.returnreasonmst&$screenWeight='+intWeight,
            method : 'POST',
