...
{
	name : 'GCP',
	appFolder : 'static/scripts/lms/NotionalQryBVNodeGross/app',
	requires :
	[
		'GCP.view.BVNodeGrossView'
	],
	controllers :
	[
	 	'GCP.controller.BVNodeGrossController'
	],
	launch : function()
	{
		objProfileView = Ext.create( 'GCP.view.BVNodeGrossView',
		{
			renderTo : 'summaryDiv'
		} );
	}
