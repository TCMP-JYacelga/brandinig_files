...
{
	name : 'GCP',
	appFolder : 'static/scripts/lms/NotionalQryBVNodeCRGross/app',
	requires :
	[
		'GCP.view.BVNodeCRGrossView'
	],
	controllers :
	[
	 	'GCP.controller.BVNodeCRGrossController'
	],
	launch : function()
	{
		objProfileView = Ext.create( 'GCP.view.BVNodeCRGrossView',
		{
			renderTo : 'summaryDiv'
		} );
	}
