...
{
	name : 'GCP',
	appFolder : 'static/scripts/lms/CPNetComputationSummary/app',
	requires :
	[
	...
	controllers :
	[
		'GCP.controller.CPNetPoolController', 'GCP.controller.CPNetSummaryController'
	],
	launch : function()
	{
		objProfileView = Ext.create( 'GCP.view.CPNetSummaryView',
		{
			renderTo : 'summaryDiv'
		} );
	}
