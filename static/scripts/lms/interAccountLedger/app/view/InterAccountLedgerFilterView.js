Ext.define( 'GCP.view.InterAccountLedgerFilterView',
		{
			...
			items : [{
						...
						listeners : 
						{
							...
							{				
								...
								{
									document.getElementById( "sellerDesc" ).value = null;	
								}
							}							
	...
	items : [{
				...
				padding : '-4 0 0 0',
				width: '100%',
				cfgUrl : 'services/userseek/interAccountLedgerClientSeek.json',
				cfgQueryParamName : '$autofilter',
				emptyText : getLabel('autoCompleterEmptyText','Enter Keyword or %'),
				cfgRecordCount : -1,
				cfgSeekId : 'interAccountLedgerClientSeek',
...
items : [{
			...
			emptyText : getLabel('autoCompleterEmptyText', 'Enter Keyword or %'),
			fieldCls : 'xn-form-text xn-suggestion-box',
			cfgUrl : 'services/userseek/interAccountLedgerAgreementSeek.json',
			cfgQueryParamName : '$autofilter',
			cfgRecordCount : -1,
			...
			listeners : {
					...
					{				
						if(combo.value == ''|| combo.value == null)
						{
							document.getElementById( "agreementRecKey" ).value = null;	
							document.getElementById( "agreementCode" ).value = null;	
							document.getElementById( "agreementDescription" ).value = null;	
						}
					}
				}
			/*cfgExtraParams :
