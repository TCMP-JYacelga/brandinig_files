Ext
	.define( 'GCP.controller.NotionalQryBVIntSettledController',
		{
			extend : 'Ext.app.Controller',
			requires :
			[
				'Ext.ux.gcp.DateHandler','GCP.view.NotionalQryBVIntSettledGridView'
			],
			views :
			[
			...
			[
				{
					ref : 'bankSettledGridViewRef',
					selector : 'notionalQryBVInterestViewType notionalQryBVIntSettledGridViewType grid[itemId="bankInterestSettledGridViewId"]'
				},
				{
					ref : 'bankSettledViewItemRef',
					selector : 'notionalQryBVInterestViewType notionalQryBVIntSettledGridViewType panel[itemId="bankSettledViewItemId"]'
				}
			],
			config :
			{
			...
			init : function()
			{
				...
				me.control(
					{
						'notionalQryBVIntSettledGridViewType' :
						{
						...
						'notionalQryBVIntSettledGridViewType smartgrid' :
						{
			...
			{
				var me = this;
				var bankAccruedGrid = me.getBankSettledGridViewRef();
			...
			getBankAccruedGridConfig : function()
			{
				...
				storeModel =
				{
					...
					proxyUrl : 'getBVBankIntSettled.srvc',
			...
			handleSmartGridLoading : function( arrCols, storeModel )
			{
				...
				pgSize = 100;
				bankSettledGrid = Ext.create( 'Ext.ux.gcp.SmartGrid',
				{
					id : 'bankInterestSettledGridViewId',
					itemId : 'bankInterestSettledGridViewId',
					pageSize : pgSize,
					autoDestroy : true,
					stateful : false,
					showEmptyRow : false,
				...
				var bankSettledGridView = me.getBankSettledViewItemRef();
				bankSettledGridView.add( bankSettledGrid );
				bankSettledGridView.doLayout();
			}
		});