Ext.define( 'GCP.view.BVNodeDRGrossSettledAccountGridView',
{
	...
	initComponent : function()
	{
		...
		var strUrl = 'getBVNodeDRGrossSettled.srvc' + '?' + csrfTokenName + '=' + csrfTokenValue + '&$viewState='
		...
		this.store = Ext.create( 'Ext.data.Store',
		{
			...
			[
				...
				'AFTER_GROSS_DR_POOL_BALANCE', 'AFTER_DEBIT_INTEREST_RATE','AFTER_DEBIT_INTEREST_AMNT', 
				'BEFORE_DEBIT_INTEREST_PROFILE','AFTER_DEBIT_INTEREST_PROFILE','CHANGE_GROSS_DEBIT_INTEREST'
			],
			remoteSort : false,
			proxy :
			{
