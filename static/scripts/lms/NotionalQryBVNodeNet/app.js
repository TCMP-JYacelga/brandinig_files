...
{
	name : 'GCP',
	appFolder : 'static/scripts/lms/NotionalQryBVNodeNet/app',
	requires :
	[
		'GCP.view.BVNodeNetView'
	],
	controllers :
	[
	 	'GCP.controller.BVNodeNetController'
	],
	launch : function()
	{
		objProfileView = Ext.create( 'GCP.view.BVNodeNetView',
		{
			renderTo : 'summaryDiv'
		} );
	}
