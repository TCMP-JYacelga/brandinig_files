	...
	.define( 'GCP.controller.ApportionmentSummaryController',
		{
			...
			getApportionmentSummaryGridConfig : function()
			{
				...
				{
					"NODE" : 115,
					"GROSS_CREDIT_BALANCE" : 160,
					"GROSS_DEBIT_BALANCE" : 160,
					"CREDIT_APPROTIONMENT_RATE" : 200,
					"CREDIT_APPORTIONMENT" : 145,
				...
				[
					...
					{
						"colId" : "CREDIT_APPROTIONMENT_RATE",
						"colDesc" : getLabel( 'summaryCreditApportRate', 'Credit Apportionment Rate' )
					},
					{
						"colId" : "CREDIT_APPORTIONMENT",
						"colDesc" : getLabel( 'summaryCreditApportionment', 'Credit Apportionment' )
					},
					{
				...
				storeModel =
				{
					fields :
					[
						'NODE', 'GROSS_CREDIT_BALANCE','GROSS_DEBIT_BALANCE',
						'CREDIT_APPROTIONMENT_RATE','DEBIT_APPROTIONMENT_RATE',
						'DEBIT_APPORTIONMENT','CREDIT_APPORTIONMENT',
						'PAIRED_NODE','DR_APPORTIONMENT_PROFILERECKEY','CR_APPORTIONMENT_PROFILERECKEY','DERIVED_PROFILE_RECKEY',
						'DATE'
					],
					proxyUrl : 'getCBGrossDteWiseApport.srvc',
			...
			columnRenderer : function( value, meta, record, rowIndex, colIndex, store, view, colId )
			{
				...
				if( value != '' && null != value)
				{
					...
					else if (colId == 'col_CREDIT_APPROTIONMENT_RATE' && "0.0000" != value && '0' == entityType)
					{
						strRetValue = '<a href="#" onclick="javascript:showInterestProfile(' + "'" + record.get( 'DERIVED_PROFILE_RECKEY' ) + "', '" + record.get( 'DATE' ) + "', '" + csrfTokenName + "', '" + csrfTokenValue + "'" + ');"><u>' + value + '%</u></a>';
					}
				}
