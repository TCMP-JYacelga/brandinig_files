	...
	.define( 'GCP.controller.BankInterestSummaryController',
		{
			...
			getBankInterestSummaryGridConfig : function()
			{
				...
				objWidthMap =
				{
					...
					"BALANCE" : 200,
					"APPLICABLE_RATE" : 250,
					"APPLICABLE_INTEREST" : 261,
					"APPORT_APPLICABLE" : 300
				};
				...
				storeModel =
				{
					fields :
					[
						'ACCOUNT', 'BALANCE', 'APPLICABLE_RATE','APPLICABLE_INTEREST','APPORT_APPLICABLE','DERIVED_PROFILE_RECKEY',
						'DATE'
					],
					proxyUrl : 'getCBGrossDteWiseBankInt.srvc',
