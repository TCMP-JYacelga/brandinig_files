Ext
	.define(
		'GCP.controller.AgreementHybridDtlController',
		{
			extend : 'Ext.app.Controller',
			requires :
			[
				'GCP.view.AgreementHybridDtlGridView','GCP.view.AgreementHybridDtlAttachAgreementPopup'
			],
			views :
			[
			...
			[
				{
					ref : 'agreementHybridDtlViewRef',
					selector : 'agreementHybridDtlViewType'
				},
				{
					ref : 'agreementHybridDtlGridViewRef',
					selector : 'agreementHybridDtlViewType agreementHybridDtlGridViewType'
				},
				{
					ref : 'agreementDtlViewRef',
					selector : 'agreementHybridDtlViewType agreementHybridDtlGridViewType panel[itemId="agreementDtlViewItemId"]'
				},
				{
					ref : 'agreementHybridDtlGridRef',
					selector : 'agreementHybridDtlViewType agreementHybridDtlGridViewType grid[itemId="gridViewMstItemId"]'
				},
				{
					ref : 'actionBarSummDtl',
					selector : 'agreementHybridDtlViewType agreementHybridDtlGridViewType agreementHybridDtlGroupActionViewType'
				},
				{
					ref : 'agreementHybridDtlFilterViewRef',
					selector : 'agreementHybridDtlViewType agreementHybridDtlFilterViewType'
				},
				{
					ref : 'btnSavePreferences',
					selector : 'agreementHybridDtlViewType agreementHybridDtlFilterViewType button[itemId="btnSavePreferences"]'
				},
				{
					ref : 'btnClearPreferences',
					selector : 'agreementHybridDtlViewType agreementHybridDtlFilterViewType button[itemId="btnClearPreferences"]'
				},
				{
					ref : 'strStructureTypeValueLabel',
					selector : 'agreementHybridDtlViewType agreementHybridDtlFilterViewType label[itemId="strStructureTypeValue"]'
				},
				{
					ref : 'strStructureSubtypeValueLabel',
					selector : 'agreementHybridDtlViewType agreementHybridDtlFilterViewType label[itemId="strStructureSubtypeValue"]'
				},
				{
					ref : 'structureSubtypeRef',
					selector : 'agreementHybridDtlFilterViewType combobox[itemId="structureSubtypeId"]'
				},				
				{
					ref : 'attachAgreementAutoCompleter',
					selector : 'attachAgreementPopup AutoCompleter[itemId="attachAgreementAutoCompleter"]'
				},				
				{
					ref : 'agreementDescriptionRef',
					selector : 'attachAgreementPopup textfield[itemId="agreementDescription"]'
				},				
				{
					ref : 'priorityRef',
					selector : 'attachAgreementPopup textfield[itemId="priority"]'
				},				
				{
					ref : 'agreementIdRef',
					selector : 'attachAgreementPopup hidden[itemId="agreementId"]'
				}
			],
			config :
			{
			...
			init : function()
			{
				...
				me.attachAgreementPopup = Ext.create( 'GCP.view.AgreementHybridDtlAttachAgreementPopup',
				{
					parent : 'agreementHybridDtlViewType',
					itemId : 'attachAgreementPopupId'
				} );
				me.control(
				{
					'agreementHybridDtlViewType' :
					{
					...
					'agreementHybridDtlViewType button[itemId="createNewItemId"]' :
					{
					...
					'agreementHybridDtlGridViewType' :
					{
						render : function( panel )
						{
					...
					'agreementHybridDtlGridViewType smartgrid' :
					{
					...
					'agreementHybridDtlViewType agreementHybridDtlGridViewType toolbar[itemId=groupActionBarItemId]' :
					{
						performGroupAction : function( btn, opts )
						{
							me.handleGroupActions( btn );
						},
						attachAgreement : function( btn, opts )
						{							
							me.attachAgreements( btn );							
						}
					},					
					'attachAgreementPopup[itemId=attachAgreementPopupId]' :
					{
					...
					'attachAgreementPopup AutoCompleter[itemId="attachAgreementAutoCompleter"]' :
					{
						select : function( combo, record, index )
						{
							var objPopUp = me.getAttachAgreementPopup();
							var objTextAgreementDesc = objPopUp.down( 'textfield[itemId="agreementDescription"]' );
							var objTextAgreementCode = objPopUp.down( 'AutoCompleter[itemId="attachAgreementAutoCompleter"]' );
							var objHiddenAgreementId = objPopUp.down( 'hidden[itemId="agreementId"]' );
							objTextAgreementCode.setValue(record[0].data.CODE);
							objTextAgreementDesc.setValue( record[ 0 ].data.DESCRIPTION );
							objHiddenAgreementId.setValue(record[ 0 ].data.RECKEY);							
							
						}
					},
					'agreementHybridDtlFilterViewType AutoCompleter[itemId="entitledSellerIdItemId"]' :
					{
						select : function( combo, record, index )
						{
							var objFilterPanel = me.getAgreementHybridDtlFilterViewRef();
					...
					'agreementHybridDtlFilterViewType AutoCompleter[itemId="clientIdItemId"]' :
					{
						select : function( combo, record, index )
						{
					...
					'agreementHybridDtlViewType agreementHybridDtlFilterViewType button[itemId="btnSavePreferences"]' :
					{
					...
					'agreementHybridDtlViewType agreementHybridDtlFilterViewType button[itemId="btnClearPreferences"]' :
					{
						click : function( btn, opts )
						{
							me.toggleSavePrefrenceAction( false );
					...
					'agreementHybridDtlViewType agreementHybridDtlFilterViewType button[itemId="btnFilter"]' : {
						click : function(btn, opts) {
				...
				$(document).on('OnSaveRestoreGrid', function(event) {
					var grid = me.getAgreementHybridDtlGridRef();
					grid.refreshData();
				});
			},
			attachAgreements : function ( btn ) {
			
				var me = this;
				if( !Ext.isEmpty( me.attachAgreementPopup ) )
				{
					me.attachAgreementPopup.destroy();
				}
				me.attachAgreementPopup = Ext.create( 'GCP.view.AgreementHybridDtlAttachAgreementPopup',
				{
					parent : 'agreementHybridDtlViewType',
				...
				me.attachAgreementPopup.down( 'button[itemId="btnSave"]' ).show();
				me.attachAgreementPopup.down( 'button[itemId="btnUpdate"]' ).hide();
				me.attachAgreementPopup.down( 'label[itemId="errorLabel"]' ).setText( '' );
				//me.enableDisableAccountFieldList();
				me.attachAgreementPopup.show();
			
			},			
			showAttachAgreementPopup : function (docmode, record) {
				...
				attachAgreementPopup = Ext.create( 'GCP.view.AgreementHybridDtlAttachAgreementPopup',
				{
					parent : 'agreementHybridDtlViewType',
					itemId : 'attachAgreementPopupId',
					mode : docmode,
					...
					userMessage : null,
					agreementId	: record.data.hybridAgreementRecKey,
					hybridAgreementCode : record.data.hybridAgreementCode,
					hybridAgreementName : record.data.hybridAgreementName					
				} );
				
				 if('EDIT'===docmode)
					{
					 attachAgreementPopup.down( 'AutoCompleter[itemId="attachAgreementAutoCompleter"]' ).setValue(record.data.hybridAgreementCode);
					 attachAgreementPopup.down( 'textfield[itemId="agreementDescription"]' ).setValue(record.data.hybridAgreementName);					
					 attachAgreementPopup.down( 'hidden[itemId="agreementId"]' ).setValue(record.data.hybridAgreementRecKey);
					 attachAgreementPopup.down( 'textfield[itemId="priority"]' ).setValue(record.data.priority);
					 attachAgreementPopup.down( 'button[itemId="btnSave"]' ).hide();
					 attachAgreementPopup.down( 'button[itemId="btnUpdate"]' ).show();
					 attachAgreementPopup.down( 'label[itemId="errorLabel"]' ).setText( '' );
					}
				 if('VIEW' ===docmode)
				 {
					 attachAgreementPopup.down( 'AutoCompleter[itemId="attachAgreementAutoCompleter"]' ).setValue(record.data.hybridAgreementCode);
					 attachAgreementPopup.down( 'AutoCompleter[itemId="attachAgreementAutoCompleter"]' ).setDisabled(true);
					 attachAgreementPopup.down( 'textfield[itemId="agreementDescription"]' ).setValue(record.data.hybridAgreementName);
					 attachAgreementPopup.down( 'textfield[itemId="agreementDescription"]' ).setDisabled(true);
					 attachAgreementPopup.down( 'hidden[itemId="agreementId"]' ).setValue(record.data.hybridAgreementRecKey);
					 attachAgreementPopup.down( 'button[itemId="btnSave"]' ).hide();
					 attachAgreementPopup.down( 'button[itemId="btnUpdate"]' ).hide();
					 attachAgreementPopup.down( 'label[itemId="errorLabel"]' ).setText( '' );
					 
				 }
				 
				 (attachAgreementPopup).show();
			...
			submitUpdateAgreement : function(identifier) {
				...
				arrayJson.push({
								...
								hybridAgreementCode : hybridAgreement,
								hybridAgreementName : hybridDescription,
								priority : priorityVal
							});
				if(!errorFlag)
				Ext.Ajax.request({
							url : 'attachAgreementToHybrid.srvc?id='+ encodeURIComponent(viewState) +'&'+csrfTokenName+'='+csrfTokenValue,
							method : 'POST',
							async : false,
			...
			{
				var me = this;
				var agreementMstGrid = me.getAgreementHybridDtlGridRef();
				var objConfigMap = me.getAgreementHybridDtlNewConfiguration();
			...
			handleRowIconClick : function( tableView, rowIndex, columnIndex, btn, event, record )
			{
				...
				if(actionName === 'btnDelete') {					
					...
					var strUrl = Ext.String.format( 'agreementHybridDtl/{0}.srvc?', strAction );
					strUrl = strUrl + csrfTokenName + "=" + csrfTokenValue;
					var grid = this.getAgreementHybridDtlGridRef();
					if( !Ext.isEmpty( grid ) )
					{
						var arrayJson = new Array();
					...
					//me.submitForm( 'deleteAgreementDtlHybrid.srvc', record, rowIndex );
				}
				...
				{
					popUpMode = 'V';
					showPopup('HybridDetailsPopupView',record);
				}			
				else if( actionName === 'btnEdit' )
				{
					popUpMode = 'E';
					updateDetails(record);
					showPopup('HybridDetailsPopup',record);
				}				
			...
			getAgreementHybridDtlNewConfiguration : function()
			{
				...
				objWidthMap =
				{
						"hybridAgreementCode" : 300,
						"hybridAgreementName" : 300,						
						"priority" : 300					
				};
				arrColsPref = [{
					"colId" : "hybridAgreementCode",
					"colDesc" : getLabel( 'hybridAgreementCode', 'Agreement Code' )
				},
				{
					"colId" : "hybridAgreementName",
					"colDesc" : getLabel( 'hybridAgreementName', 'Agreement Description' )
				},
				{
					"colId" : "priority",
				...
				storeModel = {
						fields :
							[
								'hybridAgreementCode', 'hybridAgreementName', 'priority', 'hybridAgreementRecKey',
								 'identifier', '__metadata','viewState'
							],
					proxyUrl : 'getAgreementHybridDtlList.srvc',
			...
			{
				var me = this;
				var gridObj = me.getAgreementHybridDtlGridRef();
