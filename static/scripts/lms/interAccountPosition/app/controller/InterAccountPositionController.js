Ext
	.define(
		'GCP.controller.InterAccountPositionController',
		{
			...
			requires :
			[
				'Ext.ux.gcp.DateHandler', 'GCP.view.InterAccountPositionGroupView', 'Ext.ux.gcp.PageSettingPopUp'
			],
			views :
			[
			...
			[
				{
					ref : 'interAccountPositionView',
					selector : 'interAccountPositionView'
				},
				{
				...
				{
					ref : 'groupView',
					selector : 'interAccountPositionView groupView'
				},
				{
					ref : 'interAccountPositionGroupView', //Groupview
					selector : 'interAccountPositionView interAccountPositionGroupView'
				},
				{
					ref : 'filterView',
					selector : 'filterView'
				}, 
				{
					...
					ref : 'interAccountPositionFilterView',
					selector : 'interAccountPositionFilterView'
				},
				{
					ref : 'fromDateLabel',
					selector : 'interAccountPositionFilterView label[itemId="fromDateLabel"]'
				}
			],
			config :
			{
			...
			init : function()
			{
				...
				me.control(
				{
					'interAccountPositionFilterGridViewType' :
					{
					...
					'interAccountPositionFilterGridViewType smartgrid' :
					{
				...
				me.control({
				'interAccountPositionView groupView' : {
				...
				'interAccountPositionFilterView combo[itemId="entitledSellerIdItemId"]' :
				{
					select : function( combo, record, index )
					{
						var objFilterPanel = me.getInterAccountPositionFilterView();
				...
				'interAccountPositionFilterView AutoCompleter[itemId="clientCodeItemId"]' :
				{
				...
				'interAccountPositionFilterView combo[itemId="quickFilterClientCombo"]' :
				{
				...
				'interAccountPositionFilterView AutoCompleter[itemId="agreementItemId"]' :
				{
				...
				'interAccountPositionFilterView AutoCompleter[itemId="participatingAccItemId"]' :
				{
				...
				'interAccountPositionFilterView AutoCompleter[itemId="contraAccItemId"]' :
				{
				...
				'interAccountPositionFilterView component[itemId="savedFiltersLabel22"]' : {
					render : function(c) {
				...
				'interAccountPositionFilterView component[itemId="InterAccfromDatePicker"]' : {
					render : function() {
							...
							onClose : function(dates) {
								...
								if (!Ext.isEmpty(dates)) {
									...
									/*if (dates.length == 1) {
										...
										toDate = Ext.Date.format(me.datePickerSelectedDate[0],
												strSqlDateFormat);
									}
									else if (dates.length == 2){
										fromDate = Ext.Date.format(
												me.datePickerSelectedDate[0], strSqlDateFormat);
										toDate = Ext.Date.format(me.datePickerSelectedDate[1],
												strSqlDateFormat);
									}*/
								}
							}
			...
			showPageSettingPopup : function(strInvokedFrom) {
				...
				objColumnSetting = INTERACCOUNT_POSITION_COLUMN_MODEL;
			...
			handleReconfigureGrid : function(data) {
				var me = this;
				var objGroupView = me.getGroupView();
				var objSummaryView = me.getInterAccountPositionView(), gridModel = null, objData = null;
			...
			getSummaryGridConfig : function()
			{
				...
				[
					...
					{
						"colId" : "openingPosition",
						"colDesc" : getLabel( 'lblOpeningPosition', 'Opening Position' ),
						"colType" :"number"
					},
					{
						"colId" : "netMovement",
						"colDesc" : getLabel( 'lblNetMovement', 'Net Movement' ),
						"colType" :"number"
					},
					{
						"colId" : "closingPosition",
						"colDesc" : getLabel( 'lblClosingPosition', 'Closing Position' ),
						"colType" :"number"
					},
					{
						"colId" : "rateType",
						"colDesc" : getLabel( 'lblRateType', 'Rate Type' )
					},
					{
						"colId" : "baseRateCode",
						"colDesc" : getLabel( 'lblBaseRate', 'Base rate' )
					},
					{
						"colId" : "spread",
						"colDesc" : getLabel( 'lblSpread', 'Spread' ),
						"colType" :"number"
					},
					{
						"colId" : "effectiveRate",
						"colDesc" : getLabel( 'lblEffectiveRate', 'Effective Rate' ),
						"colType" :"number"
					},
					{
						"colId" : "interestAmount",
		...
		getAgreementSummaryInfo : function() {
			...
			var objInterAccountPositionFilterGridViewRef = me
					.getInterAccountPositionFilterGridViewRef();
			...
			objInterAccountPositionFilterGridViewRef
		...
		{
			var me = this;
			var  objInterAccountPositionFilterGridViewRef = me.getInterAccountPositionFilterGridViewRef();			
			var filterAccountPosId = $('#filterAccountPosId');
			var objReadOnlyFilterPnael = $('#readOnlyHeader');
			...
			objInterAccountPositionFilterGridViewRef.addCls('ui-helper-hidden');
			
			objDownloadIcon.css('display','none');
		},
		handleClientChangeInQuickFilter : function(isSessionClientFilter) {
			var me = this;
			var clientComboBox = me.getInterAccountPositionFilterView()
		...
		handleClearSettings:function(){
			var me=this;
			var interAccountPositionFilterView = me.getInterAccountPositionFilterView();
			if(!Ext.isEmpty(interAccountPositionFilterView)){
			var agreementItemId = interAccountPositionFilterView
					.down('combobox[itemId=agreementItemId]');

			var participatingAccItemId = interAccountPositionFilterView
					.down('combobox[itemId=participatingAccItemId]');
			
			var contraAccItemId = interAccountPositionFilterView
					.down('combobox[itemId=contraAccItemId]');
			
			if(isClientUser()){
				var clientCombo = interAccountPositionFilterView.down('combobox[itemId=quickFilterClientCombo]');
				me.clientFilterVal = '';
				clientId = '';
				me.clientFilterDesc = 'all';
				clientCombo.setValue(me.clientFilterDesc);
			}else{
				interAccountPositionFilterView.down('AutoCompleter[itemId=clientCodeItemId]').setValue("");
				clientId = '';
