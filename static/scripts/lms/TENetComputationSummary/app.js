...
{
	name : 'GCP',
	appFolder : 'static/scripts/lms/TENetComputationSummary/app',
	requires :
	[
	...
	controllers :
	[
		'GCP.controller.TENetComputationSummaryController','GCP.controller.TENetComputationPoolController'
	],
	launch : function()
	{
