function filterCategoryList(frmId, mode)
{
	var frm = document.getElementById(frmId);
	if ('AUTH_MODE' == mode)
	{
		frm.action = "filterTxnCategoryAuthList.form";
	}
	else
	{
		frm.action = "filterTxnCategoryList.form";
	}
	frm.target = "";
	frm.method = "POST";
	frm.submit();
...
function showNewCategoryForm(frmId)
{
	var frm = document.getElementById(frmId);
	frm.action = "addNewTxnCategory.form";
	frm.target = "";
	frm.method = "POST";
	frm.submit();
}

function editTxnCategory(strUrl, frmId, rowIndex)
{
	var frm = document.getElementById(frmId);
...
function viewTxnCategory(strUrl, frmId, rowIndex)
{
	var frm = document.getElementById(frmId);
	document.getElementById("txtRecordIndex").value = rowIndex;
	frm.action = strUrl;
