...
Ext.define('GCP.view.HistoryPopup', {
	...
	initComponent : function() {
		...
		var clientlabel = getLabel('subscriptionName', 'Subscription Name');
		var histTitle = getLabel('subscriptionHist', 'Subscription History');
	...
	loadHistoryData : function(historyUrl, id) {
		...
		Ext.Ajax.request({
			//url : historyUrl,
			url : 'cpon/common/history.json' + '?&' + '$histSeekPageId=history.seek.alertSubscription',
			method : 'POST',
