Ext.define('GCP.view.FxSpreadSetupGridView', {
	extend : 'Ext.panel.Panel',
	requires : ['Ext.ux.gcp.SmartGrid','GCP.view.FxSpreadGroupActionBarView','Ext.panel.Panel'],
	xtype : 'fxSpreadSetupGridView',
	width : '100%',
	cls:'xn-ribbon',
	initComponent : function() {
		var me = this;
		var actionBar = Ext.create('GCP.view.FxSpreadGroupActionBarView', {
		...
		this.items = [{
			...
			title : getLabel('fxSpreadLst', 'Fx Spread List'),
			autoHeight : true,
		//	margin : '5 0 0 0',
