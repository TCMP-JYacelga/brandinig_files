Ext.define('GCP.view.SystemBeneficiaryGridView', {
	extend : 'Ext.panel.Panel',
	requires : ['Ext.ux.gcp.SmartGrid','GCP.view.SystemBeneficiaryActionBarView','Ext.panel.Panel'],
	xtype : 'systemBeneficiaryGridView',
	width : '100%',
	initComponent : function() {
		var me = this;
		var actionBar = Ext.create('GCP.view.SystemBeneficiaryActionBarView', {
		...
		this.items = [{
			...
			autoHeight : true,
			collapsible : true,
			title : getLabel('beneficiaryList', 'Beneficiary List'),
			bodyCls : 'x-portlet ux_no-padding gradiant_back',
