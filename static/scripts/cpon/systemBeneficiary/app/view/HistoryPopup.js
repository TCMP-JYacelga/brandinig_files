...
Ext.define('GCP.view.HistoryPopup', {
	...
	initComponent : function() {
		...
		var productlabel = getLabel('beneficiaryName', 'Beneficiary Name');
		var histTitle = getLabel('beneficiaryHist', 'Bank Beneficiary History');
	...
	loadHistoryData : function(historyUrl, id) {
		...
		Ext.Ajax.request({
			//url : historyUrl,
			url : 'cpon/common/history.json' + '?&' + '$histSeekPageId=history.seek.bankBeneficiary',
			method : 'POST',
