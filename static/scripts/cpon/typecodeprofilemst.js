...
function submitTypeCodeProfile(strUrl)
{
	var frm = document.forms["frmMain"];
	enableDisableForm(false);
	
	if(typeof typeCodeDetailItemCountSelectionsArray !== undefined && typeCodeDetailItemCountSelectionsArray.length!=0){
		var jsonObj = {};
		jsonObj['jsonMapOfAssignedItemCount'] = typeCodeDetailItemCountSelectionsArray;
		document.getElementById('jsonMapOfAssignedItemCount').value = JSON.stringify(jsonObj); 
	}
	if(typeof typeCodeDetailHeaderSelectionsArray !== undefined && typeCodeDetailHeaderSelectionsArray.length!=0){
		var jsonObj = {};
		jsonObj['jsonMapOfHeader'] = typeCodeDetailHeaderSelectionsArray;
		document.getElementById('jsonMapOfHeader').value = JSON.stringify(jsonObj); 
	}
