var fieldJson = [];
Ext.define('GCP.view.CollectionFeaturePopup', {
	...
	resizable : false,
	closeAction : 'hide',
	title : getLabel('collectionfeatures', 'Receivables Features'),
...
//					}
	...
	setPWDOptions : function() {
		...
		Ext.each(filteredData, function(feature, index) {
					...
					/*if (obj.featureId == 'EDITSTNDWORKFLOW'
							|| obj.featureId == 'NEWWORKFLOWDEF')*/
						obj.disabled = true;
		...
		Ext.each(fieldJson, function(field, index) {
			...
			if (element != null && element != undefined) {
				...
				if (viewmode == 'MODIFIEDVIEW') {
					element.boxLabelCls = me.getOldNewValueClass(field) + " "
							+ element.boxLabelCls;
				}
			}  else {
