Ext.define('GCP.view.copyOtherProfileSeek', {
			extend : 'Ext.window.Window',
			xtype : 'copyOtherProfileSeek',
			...
			initComponent : function() {
				...
				adminListView = Ext.create('Ext.ux.gcp.SmartGrid', {
							...
							storeModel : {
								fields : ['name','value'],
								proxyUrl : 'cpon/copyProfile/otherProfileSeek.json',
								rootNode : 'd.filter',
							...
							otherBoxColumnRenderer : function(value, metaData,
