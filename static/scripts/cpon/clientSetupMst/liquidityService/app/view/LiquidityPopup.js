Ext
		.define(
				'CPON.view.LiquidityPopup',
				{
					...
					closeAction : 'hide',
					autoScroll : true,
					title : getLabel('copyliquidityprofile',
							'Copy Liquidity Profile'),
					config : {
						filterVal : null
					},
						...
						packageFilterfield = Ext
								.create(
										'Ext.ux.gcp.AutoCompleter',
										{
											...
											cfgRecordCount : -1,
											cfgSeekId : 'liquidityProfileSeek',
						...
						adminListView = Ext
								.create(
										'Ext.ux.gcp.SmartGrid',
										{
											...
											storeModel : {
												fields : [ 'name', 'value' ],
												proxyUrl : 'cpon/copyProfile/liquidityProfileSeek.json',
												rootNode : 'd.filter',
					...
					selectProfile : function(parent, profileId) {
						...
						form.action = 'doCopyLiquidityProfile.form';
