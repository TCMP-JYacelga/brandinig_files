Ext
		.define(
				'CPON.view.PositivePayPopup',
				{
					...
					closeAction : 'hide',
					autoScroll : true,
					title : getLabel('copypositivepayprofile',
							'Copy Positive Pay Profile'),
					config : {
						filterVal : null
					},
						...
						packageFilterfield = Ext
								.create(
										'Ext.ux.gcp.AutoCompleter',
										{
											...
											cfgRecordCount : -1,
											cfgSeekId : 'positivePayProfileSeek',
						...
						adminListView = Ext
								.create(
										'Ext.ux.gcp.SmartGrid',
										{
											...
											storeModel : {
												fields : [ 'name', 'value' ],
												proxyUrl : 'cpon/copyProfile/positivePayProfileSeek.json',
												rootNode : 'd.filter',
					...
					selectProfile : function(parent, profileId) {
						...
						form.action = 'doCopyPositivePayProfile.form';
