...
function submitChargingFreqProfile(strUrl)
{
	var frm = document.forms["frmMain"];
	enableDisableForm(false);
	$('#nextComputationDate').removeAttr('disabled');
	$('#nextPostingDate').removeAttr('disabled');
	frm.action = strUrl;
	frm.target = "";
	frm.method = "POST";
	frm.submit();	
...
function enableDisableForm(boolVal) {
	...
	$('#computationFrequencyPeriod').val($('#computationFrequencyPeriodSelect').val());
	$('#postingFrequencyPeriod').val($('#postingFrequencyPeriodSelect').val());
	$('#computationFrequencyPeriodSelect').attr('disabled', boolVal);
	$('#postingFrequencyPeriodSelect').attr('disabled', boolVal);
	$('#computationFrequencyTypeI').attr('disabled', boolVal);
	$('#computationFrequencyTypeD').attr('disabled', boolVal);
	$('#computationFrequencyTypeM').attr('disabled', boolVal);
	$('#postingFrequencyTypeI').attr('disabled', boolVal);
	$('#postingFrequencyTypeD').attr('disabled', boolVal);
	$('#postingFrequencyTypeM').attr('disabled', boolVal);
}
