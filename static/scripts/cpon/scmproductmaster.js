function gotoPage(strUrl) {
	...
	$("#productDescription").removeAttr("disabled");
	$("#portfolioLimit").removeAttr("disabled");
	$("#recoursePercentage").removeAttr("disabled");
	$("#recourseAmount").removeAttr("disabled");
	$("#maxPercentageEntity").removeAttr("disabled");
	$("#vendor").removeAttr("disabled");
	$("#dealer").removeAttr("disabled");
	$("#effectiveData").removeAttr("disabled");
	$("#invoiceEntryBy").removeAttr("disabled");
	$("#poEntryBy").removeAttr("disabled");
...
function gotoNextPage(strUrl){
	var frm = document.forms["frmAccountMain"];
	frm.action = strUrl;
	frm.target = "";
	frm.method = "POST";
	frm.submit();
...
function setCheckUncheckView(flag, field) {
	if (flag == 'Y') {
...
function setCheckUnchekAcceptance(flag, field) {
	if (flag == 'Y') {
		$('#' + field).attr('src', 'static/images/icons/icon_checked.gif');
	} else {
		$('#' + field).attr('src', 'static/images/icons/icon_unchecked_grey.gif');
