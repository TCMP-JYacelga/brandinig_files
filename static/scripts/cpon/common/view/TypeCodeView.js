Ext.define('GCP.view.TypeCodeView', {
			...
			getColumns : function() {
				...
				var arrColsPref = [{
							...
							"colId" : "liquidity",
							"colDesc" : getLabel("btrTypeCodeLiq","Liquidity")+"&nbsp; <span class='button_underline thePoniter ux_font-size14-normal'>(Max 20)</span>"
						}, {
							"colId" : "grid",
							"colDesc" : "Grid &nbsp; <span class='button_underline thePoniter ux_font-size14-normal'>(Max 20)</span>"
						}, {
							"colId" : "header",
							"colDesc" : getLabel("btrTypeCodeHdr","Header")+"&nbsp; <span class='button_underline thePoniter ux_font-size14-normal'>(Max 6)</span>"
						}];
