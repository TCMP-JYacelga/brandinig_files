...
Ext.define('GCP.view.TradeFeaturePopup', {
	...
	initComponent: function() {
	  ...
	  thisClass.bbar=(viewmode == 'VIEW' || viewmode == "MODIFIEDVIEW"
						|| viewmode == "VERIFY")?['->',{ 
						  ...
						  if(typeof strTradePrevililegesList === 'object' && strTradePrevililegesList!=null){
							strTradePrevililegesList = JSON.stringify(strTradePrevililegesList);	
						  }
			        		thisClass.close();
			        				}
			          }]:[
	...
	getColumns : function() {
			...
			saveItems : function() {
				...
				var me = this;
				var grid = me.down('grid[itemId=tradeFeatureViewGrid]');
