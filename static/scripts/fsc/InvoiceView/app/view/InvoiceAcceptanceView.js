Ext.define('GCP.view.InvoiceAcceptanceView', {
	extend : 'Ext.panel.Panel',
	xtype : 'pOAcceptanceView',
	autoHeight : true,
	initComponent : function() {
		var me = this;
		var strUrl = 'services/invoiceview/acceptanceDetails/('+viewState+')';
		var smartGrid = Ext.create('Ext.ux.gcp.SmartGrid', {
					...
					storeModel : {
						fields : ['invoiceAcceptanceReferenceNumber','deductedAmount','acceptedAmount','remarks','displayState', 'identifier','viewState'],
						proxyUrl : strUrl,
	...
	getColumns : function() {
		...
		var arrColsPref = [{
					"colId" : "invoiceAcceptanceReferenceNumber",
	...
	columnRenderer : function(value, meta, record, rowIndex, colIndex, store,
		...
		}else if((colId === 'col_invoiceAcceptanceReferenceNumber') && !Ext.isEmpty(value)){
			return "<a href=\"#\" onclick=\"viewAcceptance('viewInvAccepFrmInv.form','frmMain','"+record.data.identifier +"', '"+record.raw.enteredByClient+"');\"><u>"+value+"</u></a>";
		}else{
			return value;
		}
	},
