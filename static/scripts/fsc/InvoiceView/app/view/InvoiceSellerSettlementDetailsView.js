Ext.define('GCP.view.InvoiceSellerSettlementDetailsView', {
	extend : 'Ext.panel.Panel',
	xtype : 'pOSellerSettlementDetailsView',
	autoHeight : true,
	initComponent : function() {
		var me = this;
		var strUrl = 'services/invoiceview/sellerSettlementDetails/('+viewState+')';
		var smartGrid = Ext.create('Ext.ux.gcp.SmartGrid', {
					...
					storeModel : {
						fields : ['settlementMode','transactionRef','reconciledAmount','creditToAccount','settlementDate'],
						proxyUrl : strUrl,
						rootNode : 'd.sellerSettlementDetails',
	...
	getColumns : function() {
		...
		var arrColsPref = [{
					...
					"colId" : "reconciledAmount",
					"colDesc" : getLabel('reconciledamt', 'Reconciled Amount'),
					"sortable" : false,
					"menuDisabled" : false,
					"colType" : 'number'
				}, {
					"colId" : "creditToAccount",
	...
	columnRenderer : function(value, meta, record, rowIndex, colIndex, store,
		...
		if(Ext.isEmpty(value)){
			strReturnValue = "";
		}else if( colId === "col_reconciledAmount" && !Ext.isEmpty(value)){
