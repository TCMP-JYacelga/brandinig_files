Ext.define('GCP.view.InvAcceptSummaryView', {
	extend : 'Ext.panel.Panel',
	xtype : 'pOSummaryView',
	requires : ['Ext.ux.gcp.GroupView', 'GCP.view.InvAcceptSummaryFilterView'
			],
	autoHeight : true,
	// width : '100%',
	...
	createGroupView : function(selectedFilterLoggerDesc) {
		...
		groupView = Ext.create('Ext.ux.gcp.GroupView', {
			cfgGroupByUrl :'services/grouptype/invoiceAcceptanceCenter/INVACP.json?$filterGridId=GRD_FSC_INVACPCEN&$filterscreen='+selectedFilterLoggerDesc, 
			...
			cfgGridModel : {
				...
				storeModel : {
					//fields :['poBatchNumber','poReferenceNmbr','poDate','poAmount','subsidiary','buyerSeller','scmMyProduct','purchaseOrderStatus','__metadata','identifier','scmMyProductDesc','buyerSellerDesc','subsidiaryDesc','poInternalRefNmbr','purchaseOrderVerifyStatus','purchaseOrderFinanceStatus','purchaseOrderPaymentStatus','poCurrencyCode','anchorClient','invoiceApplicable','scmMyProductDesc','productWorkflow','mypRelClient','poReferenceNmbr','poInternalRefNmbr','dealerVendorCode'],
					fields :['invoiceBatchNumber','invoiceNumber','invoiceAmount','invoiceReqAmount','invoiceDueDate','buyerSellerDesc','scmMyProductDesc', 'currencySymbol',
					         'financeRef','__metadata','identifier','invoiceStatus','subsidiaryDesc','scmMyProductName','invoiceFinanceAmount','invoiceAcceptanceStatus', 
					         'invoiceFinIntRefNmbr','requestDate','invoiceCurrencyCode','company', 'invoiceDueDate','invoiceDate','status','acceptedAmount','clientId','totalAcceptedAmnt','deductedAmount','invoiceAcceptRefNumber'],
					proxyUrl : 'services/invoiceAcceptanceList/'+selectedFilterLoggerDesc+'.json',
					rootNode : 'd.invoiceAcceptance',
	...
	columnRenderer : function(value, meta, record, rowIndex, colIndex, store,
		...
		var PENDING_ACCEPTED, PENDING_FINANCE = '<a class="linkbox grid-link-icon empty_link" href="#"></a>';
		var PARTIAL_ACCEPTED = '<a class="linkbox grid-link-icon half_filledlink" href="#"></a>';
		var COMPLETE_ACCEPTED, COMPLETE_FINANCE = '<a class="linkbox grid-link-icon full_filledlink" href="#"></a>';
		var statusIcons = {};
		
		if (colId === 'col_invoiceAmount' || colId === 'col_acceptedAmount' ) {
	...
	getGroupActionModel : function(arrAvaliableActions) {
		...
		var arrActions = (arrAvaliableActions || ['Submit', 'Authorize',
				'Accept', 'Delete', 'Upload', 'Send', 'Verify','PayNow', 'RequestFinance']);
		var objActions = {
