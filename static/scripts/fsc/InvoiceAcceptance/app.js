...
Ext.application({
			name : 'GCP',
			appFolder : 'static/scripts/fsc/InvoiceAcceptance/app',
			requires : ['Ext.ux.gcp.PreferencesHandler', 'Ext.ux.data.PagingMemoryProxy',
					'Ext.ux.gcp.GroupView', 'GCP.view.InvAcceptSummaryView',
					'Ext.ux.gcp.vtypes.CustomVTypes'],
			controllers : ['GCP.controller.InvAcceptSummaryController'],
			...
			launch : function() {
				...
				objSummaryView = Ext.create('GCP.view.InvAcceptSummaryView', {
