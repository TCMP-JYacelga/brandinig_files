...
Ext.application({
			name : 'GCP',
			appFolder : 'static/scripts/fsc/InvoiceFinance/app',
			requires : ['Ext.ux.gcp.PreferencesHandler', 'Ext.ux.data.PagingMemoryProxy',
					'Ext.ux.gcp.GroupView', 'GCP.view.InvoiceFinanceSummaryView',
					'Ext.ux.gcp.vtypes.CustomVTypes'],
			controllers : ['GCP.controller.InvoiceFinanceSummaryController'],
			...
			launch : function() {
				...
				objSummaryView = Ext.create('GCP.view.InvoiceFinanceSummaryView', {
