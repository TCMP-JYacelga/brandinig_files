Ext.define('GCP.view.InvoiceFinanceSummaryView', {
	extend : 'Ext.panel.Panel',
	xtype : 'pOSummaryView',
	requires : ['Ext.ux.gcp.GroupView', 'GCP.view.InvoiceFinanceSummaryFilterView'
			],
	autoHeight : true,
	// width : '100%',
	...
	createGroupView : function(selectedFilterLoggerDesc) {
		...
		groupView = Ext.create('Ext.ux.gcp.GroupView', {
			cfgGroupByUrl :'services/grouptype/invoiceFinanceCenter/INVFIN.json?$filterGridId=GRD_FSC_INVFINCEN&$filterscreen='+selectedFilterLoggerDesc, 
			...
			cfgGridModel : {
				...
				storeModel : {
					...
					fields :['invoiceBatchNumber','invoiceNumber','invoiceAmount','invoiceReqAmount','invoiceDueDate','buyerSellerDesc','scmMyProductDesc', 'currencySymbol',
					         'financeRef','__metadata','identifier','invoiceStatus','subsidiaryDesc','scmMyProductName','invoiceFinanceAmount','invoiceFinanceStatus', 'invoiceFinIntRefNmbr','requestDate','invoiceCurrencyCode','company'],
					proxyUrl : 'services/invoiceFinanceList/'+selectedFilterLoggerDesc+'.json',
					rootNode : 'd.invoiceFinance',
	...
	columnRenderer : function(value, meta, record, rowIndex, colIndex, store,
		...
		if (colId === 'col_invoiceAmount' || colId === 'col_invoiceFinanceAmount' ) {
