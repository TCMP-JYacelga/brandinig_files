...
Ext.define('GCP.view.HistoryPopup', {
	...
	initComponent : function() {
		...
		var histTitle = getLabel('loanRepaySOHistory', 'Loan Repayment Standing Order History');
	...
	loadHistoryData : function(historyUrl, id) {
		...
		Ext.Ajax.request({
		//	url : historyUrl,
			url : 'services/common/history.json' + '?&' + '$histSeekPageId=history.seek.loanRepayStandingOrder',
			method : 'POST',
