Ext.define('GCP.view.ProcessFinanceRequestGridView', {
	...
	initComponent : function() {
		var me = this;
		var actionBar = Ext.create('GCP.view.ProcessFinanceRequestActionBarView', {
			itemId : 'processFinanceReqActionDtl',
			height : 21,
			width : '100%',
			margin : '1 0 0 0',
			parent : me
