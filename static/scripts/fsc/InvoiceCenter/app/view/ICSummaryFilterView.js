Ext.define("GCP.view.ICSummaryFilterView",{
	...
	initComponent : function() {
		...
		Ext.Ajax.request({
					...
					success : function(response) {
						...
						numberOfclientsize = data.length;
						if (clientStore) {
	...
	savedFilterStore : function() {
		var myStore = new Ext.data.ArrayStore({
					...
					proxy : {
						type : 'ajax',
						url : Ext.String.format('services/userfilterslist/ICCenterGroupViewFilter{0}.json', selectedFilterLoggerDesc),
						reader : {
							type : 'json',
							root : 'd.filters'
						}
