Ext.define('GCP.view.LineItemsGridView', {
	extend : 'Ext.panel.Panel',
	requires : ['Ext.ux.gcp.SmartGrid','GCP.view.LineItemsGroupActionBarView','Ext.panel.Panel'],
	xtype : 'lineItemsGridView',
	width : '100%',
	cls:'xn-ribbon',
	initComponent : function() {
		var me = this;
		var actionBar = Ext.create('GCP.view.LineItemsGroupActionBarView', {
					itemId : 'lineItemsGroupActionBarView_clientDtl',
					height : 21,
					width : '100%',
		...
		this.items = [{
			...
			width : '100%',
			collapsible : true,
			title : getLabel('receiverList', 'Receiver List'),
