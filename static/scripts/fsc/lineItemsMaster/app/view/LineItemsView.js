Ext.define('GCP.view.LineItemsView', {
	extend : 'Ext.container.Container',
	xtype : 'lineItemsView',
	requires : ['Ext.container.Container','GCP.view.LineItemsFilterView', 'Ext.ux.gcp.GroupView'],
	autoHeight : true,
	...
	createGroupView : function() {
		...
		groupView = Ext.create('Ext.ux.gcp.GroupView', {
			...
			cfgGroupByUrl : 'services/grouptype/lineItemMaster/groupBy.json?$filterscreen=groupViewFilter&$filterGridId=GRD_FSC_LINEITEMS',
			...
			cfgGridModel : {
				...
				storeModel:{
					fields : ['requestStateDesc','lineCode', 'lineDesc', 'clientDesc', 'scfPackage',
							'lastRequestState','identifier', 'history', 'isSubmitted',
							'lineType','makerId','__metadata'],
					proxyUrl : 'services/lineItemsList.json',
