/**
 * @class GCP.view.ExtendCreditFilterView
 * @extends Ext.panel.Panel
 * @author Preeti Kapade
 */
Ext.define('GCP.view.ExtendCreditFilterView',
{
	...
	initComponent : function()
	{
		...
		},
		{
			...
			//Panel 2
			{
					...
					[{
						xtype : 'label',
						text : getLabel('finReqRefNo', 'Finance Request Reference'),
						cls : 'frmLabel'
						//flex : 0.20
					},{
						xtype : 'AutoCompleter',
					...
					itemId : 'finReqRefNo',
					cfgUrl : 'services/userseek/finReqRefSeek.json',
					cfgQueryParamName : '$autofilter',
					cfgRecordCount : -1,
					cfgSeekId : 'finReqRefSeek',
					cfgRootNode : 'd.preferences',
					cfgDataNode1 : 'CODE',
					cfgKeyNode : 'CODE',
					enableQueryParam:false,
