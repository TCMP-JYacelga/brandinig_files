Ext.define("GCP.view.InvoiceReconFilterView", {
	...
	initComponent : function() {
		...
		me.items = [{
			...
			items : [{
						...
						listeners : {
							'select' : function(combo, record) {
								...
								var strUrl = 'services/userpreferences/invRecon/screenFilters.json';
										Ext.Ajax.request({
			...
			items : [{
				...
				items : [{
					xtype : 'label',
					text :getLabel('invRefNo', 'Invoice Number')
					},
					{
						xtype : 'textfield',
						hideTrigger : true,
	...
	savedFilterStore : function() {
		var myStore = new Ext.data.ArrayStore({
					...
					proxy : {
						type : 'ajax',
						url : Ext.String.format('services/userfilterslist/InvoiceAdvFilter{0}.json', selectedFilterLoggerDesc),
						reader : {
							type : 'json',
							root : 'd.filters'
						}
