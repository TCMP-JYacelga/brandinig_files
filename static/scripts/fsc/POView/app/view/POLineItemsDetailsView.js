Ext.define('GCP.view.POLineItemsDetailsView',{
	extend:'Ext.panel.Panel',
	requires : ['Ext.ux.gcp.SmartGrid', 'Ext.data.Store'],
	xtype:'poLineItemsDetailsView',
	
	initComponent : function(){
		var me = this;
		var strUrl = 'services/purchaseorderview/lineitemdetails/('+viewState+')';
		var lineItemsSmartGrid = Ext.create('Ext.ux.gcp.SmartGrid',{
				...
				storeModel:{
					fields:['lineDesc','quantity','rate','lineAmount','remarks','amountOperator'],
					proxyUrl:strUrl,
	...
	getColumnModel : function(){
		...
		var arrColsPref = [
		           ...
		           {
		        	   "colId" : 'amountOperator',
		        	   "colDesc" : getLabel('amountOperator', '+/-'),
		        	   "sortable" : false,
		        	   "menuDisabled" : false
		           },
		           {
