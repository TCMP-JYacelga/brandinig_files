Ext.define('GCP.view.POLoanSettlementDetailsView', {
	extend : 'Ext.panel.Panel',
	xtype : 'pOLoanSettlementDetailsView',
	autoHeight : true,
	initComponent : function() {
		var me = this;
		var strUrl = 'services/purchaseorderview/loanSettlementDetails/('+viewState+')';
		var smartGrid = Ext.create('Ext.ux.gcp.SmartGrid', {
					...
					storeModel : {
						fields : ['pofinanceReferenceNumber','settlementMode','receiptAmount','transactionAmount','settledAmount','loanSettlementDate'],
						proxyUrl : strUrl,
