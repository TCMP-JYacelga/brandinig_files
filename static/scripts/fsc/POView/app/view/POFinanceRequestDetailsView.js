Ext.define('GCP.view.POFinanceRequestDetailsView',{
	extend:'Ext.panel.Panel',
	requires : ['Ext.ux.gcp.SmartGrid', 'Ext.data.Store'],
	xtype:'poFinanceRequestDetailsView',
	
	initComponent : function(){
		var me = this;
		var strUrl = 'services/purchaseorderview/financedetails/('+viewState+')';
		var financeRequestSmartGrid = Ext.create('Ext.ux.gcp.SmartGrid',{
				...
				storeModel:{
				fields:['poFinanceReferenceNumber','poFinanceAmount','remarks','rejectRemarks','status','actaulSendDate'],
				proxyUrl:strUrl,
	...
	getColumnModel : function(){
		...
		var arrColsPref = [
				{
					   "colId" : "poFinanceReferenceNumber",
	...
	columnRenderer : function(value, meta, record, rowIndex, colIndex, store,view, colId){
		...
		if(Ext.isEmpty(value)){
			strReturnValue = "";
		}else if((colId === "col_poFinanceAmount") && !Ext.isEmpty(value)){
