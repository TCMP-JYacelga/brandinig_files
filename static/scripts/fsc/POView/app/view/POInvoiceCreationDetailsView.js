Ext.define('GCP.view.POInvoiceCreationDetailsView', {
	extend : 'Ext.panel.Panel',
	xtype : 'pOInvoiceCreationDetailsView',
	autoHeight : true,
	initComponent : function() {
		var me = this;
		var strUrl = 'services/purchaseorderview/invoiceCreationDetails/('+viewState+')';
		var smartGrid = Ext.create('Ext.ux.gcp.SmartGrid', {
					...
					storeModel : {
						fields : ['invoiceNumber','invoiceAmount','totalAcceptedAmount','displaystate','invoiceDueDate','outstandingAmount', 'identifier','viewState','invoiceInternalReferenceNumber'],
						proxyUrl : strUrl,
	...
	columnRenderer : function(value, meta, record, rowIndex, colIndex, store,
		...
		if(Ext.isEmpty(value)){
			strReturnValue = "";
		}else if((colId === "col_invoiceAmount" ||colId === "col_totalAcceptedAmount" ||colId === "col_outstandingAmount") && !Ext.isEmpty(value)){
