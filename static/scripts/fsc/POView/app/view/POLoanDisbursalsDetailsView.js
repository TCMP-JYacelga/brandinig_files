Ext.define('GCP.view.POLoanDisbursalsDetailsView',{
	extend:'Ext.panel.Panel',
	requires : ['Ext.ux.gcp.SmartGrid', 'Ext.data.Store'],
	xtype:'poLoanDisbursalsDetailsView',
	
	initComponent : function(){
		var me = this;
		var strUrl = 'services/purchaseorderview/loanDisbursalDetails/('+viewState+')';
		 var loanDisbursalsSmartGrid = Ext.create('Ext.ux.gcp.SmartGrid',{
			 stateful : false,
				...
				storeModel:{
				fields:['processedDate','expectedRepaymentDate','upfrontInterestDiducted','poFinanceReferenceNumber','processedAmnt','requestedAmnt','rejectReason','settlementStatus',''],
				proxyUrl:strUrl,
