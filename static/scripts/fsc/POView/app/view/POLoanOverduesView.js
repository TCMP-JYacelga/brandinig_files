Ext.define('GCP.view.POLoanOverduesView', {
	extend : 'Ext.panel.Panel',
	xtype : 'pOLoanOverduesView',
	autoHeight : true,
	initComponent : function() {
		var me = this;
		var strUrl = 'services/purchaseorderview/loanOverdueDetails/('+viewState+')';
		var smartGrid = Ext.create('Ext.ux.gcp.SmartGrid', {
					...
					storeModel : {
						fields : ['pofinanceReferenceNumber','overdueDescription','overdueDate','overdueActionDesc','overdueAmnt'],
						proxyUrl : strUrl,
