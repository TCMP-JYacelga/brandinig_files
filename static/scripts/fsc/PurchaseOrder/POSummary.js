...
var arrPOStatus = 	[
	  ...
	  */
	  {
		"code": "1",
		"desc": getLabel('poStatus.2','Pending Approval')
	  },
	  {
		"code": "2",
		"desc": getLabel('poStatus.3','Pending My Approval')
	  },
	  {
			"code": "3",
			"desc": getLabel('poStatus.10','Pending Presentment')
      },
	  {
		"code": "4",
...
function getLabel(key, defaultText) {
	return (poLabelsMap && poLabelsMap[key]) ? poLabelsMap[key]: defaultText;
}
