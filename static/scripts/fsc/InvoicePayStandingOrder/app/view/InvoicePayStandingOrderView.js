Ext.define('GCP.view.InvoicePayStandingOrderView', {
	extend : 'Ext.container.Container',
	xtype : 'invoicePayStandingOrderView',
	requires : ['Ext.container.Container','Ext.ux.gcp.GroupView', 'GCP.view.InvoicePayStandingOrderFilterView'],
	...
	createGroupView : function() {
		...
		if (objInvoicePayStandingOrderPref) {
			var objJsonData = Ext.decode(objInvoicePayStandingOrderPref);
		...
		groupView = Ext.create('Ext.ux.gcp.GroupView', {
			cfgGroupByUrl : 'services/grouptype/invoicePayStandingOrder/groupBy.json?$filterGridId=GRD_FSC_INPAYSO',
			cfgParentCt : me,
			cls : 't7-grid',
			cfgShowFilter : true,
			...
			cfgFilterModel : {
				cfgContentPanelItems : [{
					xtype : 'invoicePayStandingOrderFilterView'
				}],
			...
			cfgGridModel : {
				...
				storeModel : {
					...
					proxyUrl : 'services/standingOrderMst.json',
					rootNode : 'd.summaryList',
					totalRowsNode : 'd.__count'
				},
				groupActionModel : me.getGroupActionModel(),
				defaultColumnModel : me.getColumnModel(INVOICE_PAY_STANDING_ORDER_COLUMNS),
