...
Ext.define('GCP.view.HistoryPopup', {
	...
	initComponent : function() {
		...
		var billerLabel = getLabel('biller', 'Biller');
		var scmProductLabel = getLabel('scmProduct', 'SCF Package')
		var histTitle = getLabel('invoicePaySOHistory', 'Invoice Payment Standing Order History');
	...
	loadHistoryData : function(historyUrl, id) {
		...
		Ext.Ajax.request({
		//	url : historyUrl,
			url : 'services/common/history.json' + '?&' + '$histSeekPageId=history.seek.invoivePayStandingOrder',
			method : 'POST',
