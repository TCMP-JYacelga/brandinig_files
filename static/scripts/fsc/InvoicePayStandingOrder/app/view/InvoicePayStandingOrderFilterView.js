Ext.define("GCP.view.InvoicePayStandingOrderFilterView", {
				...
				items : [
				 {
					...
					xtype : 'AutoCompleter',
					name : 'billerAutocompleter',
					itemId : 'billerAutocompleter',
					cfgUrl : 'services/userseek/invoicePaySoBillerSeek.json',
					cfgQueryParamName : '$autofilter',
					cfgRecordCount : -1,
					cfgKeyNode : 'CODE',
					width : 247,
				...
				items : [
				 {
					...
					cfgUrl : 'services/userseek/invoicePaySoScmProductSeek.json',
					cfgQueryParamName : '$autofilter',
					cfgRecordCount : -1,
					cfgKeyNode : 'CODE',
					width : 247,
