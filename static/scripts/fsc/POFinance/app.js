...
Ext.application({
			name : 'GCP',
			appFolder : 'static/scripts/fsc/POFinance/app',
			requires : ['Ext.ux.gcp.PreferencesHandler', 'Ext.ux.data.PagingMemoryProxy',
					'Ext.ux.gcp.GroupView', 'GCP.view.POFinanceSummaryView',
					'Ext.ux.gcp.vtypes.CustomVTypes'],
			controllers : ['GCP.controller.POFinanceSummaryController'],
			...
			launch : function() {
				...
				objSummaryView = Ext.create('GCP.view.POFinanceSummaryView', {
