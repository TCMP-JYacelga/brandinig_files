Ext.define('GCP.view.POFinanceSummaryView', {
	extend : 'Ext.panel.Panel',
	xtype : 'pOFinanceSummaryView',
	requires : ['Ext.ux.gcp.GroupView', 'GCP.view.POFinanceSummaryFilterView'
			],
	autoHeight : true,
	// width : '100%',
	...
	createGroupView : function(selectedFilterLoggerDesc) {
		...
		groupView = Ext.create('Ext.ux.gcp.GroupView', {
			cfgGroupByUrl :'services/grouptype/purchaseOrderFinanceCenter/POFIN.json?$filterGridId=GRD_FSC_POFINCEN&$filterscreen='+selectedFilterLoggerDesc, 
			...
			cfgFilterModel : {
				cfgContentPanelItems : [{
							xtype : 'pOFinanceSummaryFilterView'
						}],
			...
			cfgGridModel : {
				...
				storeModel : {
					fields :['companyName','poBatchNumber','poAmount','buyerSeller','__metadata','identifier','buyerSellerDesc','poRefNumber','poFinanceAmount','requestDate','scmMyProductName','financeRef','purchaseOrderFinanceStatus','poCurrencyCode','currencySymbol','poFinIntRefNmbr','poInternalReferenceNumber','subsidiaryDesc','company'],
					proxyUrl : 'services/purchaseOrderFinanceList/'+selectedFilterLoggerDesc+'.json',
	...
	columnRenderer : function(value, meta, record, rowIndex, colIndex, store,
		...
		var statusIcons = {};
		if (colId === 'col_poAmount' || colId === 'col_poFinanceAmount') {
