Ext.define("GCP.view.POFinanceSummaryFilterView",{
			...
			items : [{
						...
						listeners : {
							'select' : function(combo, record) {
								...
								var strUrl = 'services/userpreferences/purchaseOrderFinanceCenter/screenFilters.json';
										Ext.Ajax.request({
	...
	getPoFinanceRefURL : function(){
		var strUrl = 'services/userseek/' +(selectedFilterLoggerDesc == 'SELLER' ? 'poFinanceReferenceSellerMode' : 'poFinanceReferenceBuyerMode');
