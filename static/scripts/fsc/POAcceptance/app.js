...
Ext.application({
			name : 'GCP',
			appFolder : 'static/scripts/fsc/POAcceptance/app',
			requires : ['Ext.ux.gcp.PreferencesHandler', 'Ext.ux.data.PagingMemoryProxy',
					'Ext.ux.gcp.GroupView', 'GCP.view.POAcceptanceSummaryView',
					'Ext.ux.gcp.vtypes.CustomVTypes'],
			controllers : ['GCP.controller.POAcceptanceSummaryController'],
			...
			launch : function() {
				...
				objSummaryView = Ext.create('GCP.view.POAcceptanceSummaryView', {
