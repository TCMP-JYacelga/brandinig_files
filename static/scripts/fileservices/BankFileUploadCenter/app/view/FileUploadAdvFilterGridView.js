Ext.define( 'GCP.view.FileUploadAdvFilterGridView',{
	...
	listeners: {
		cellclick: function(view, td, cellIndex, record,tr, rowIndex, e, eOpts) {
			...
			var IconLinkClicked = (e.target.tagName == 'A' || e.target.tagName == 'I');	
		   if(IconLinkClicked){
		        var className = e.target.className;
	...
	initComponent : function()
	{
		...
		//{
			strUrl = 'userfilterslist/fileUploadCenter.srvc';
		//}
		...
		[
			...
			},
			{
				...
				parent : this,
						renderer: function(value, metaData, record, rowIndex, colIndex, store){ 
							return '<a href="#" title="Delete"><i class="fa fa-remove"></i></a>';
						}
			},
			{
				width : 65,
