				...
				this.items = [{
					...
					items : [{
						...
						items : [{
									...
									fieldLabel : getLabel('uploadDate',
											'Import Date'),
									labelWidth : 150,
									margin : '5 10 0 10',
						...
						items : [{
							...
							fieldLabel : getLabel('totalTransaction',
							...
							fieldLabel : getLabel('totalControlAmount',
									'Control Amount'),
							labelWidth : 150,
							margin : '5 10 0 10',
							...
							fieldLabel : getLabel('totalRejTransaction',
