...
Ext.application({
			name : 'GCP',
			appFolder : 'static/scripts/collections/receivableT7/app',
			requires : ['GCP.view.BatchInstrumentEntryInGridLayout','Ext.ux.data.PagingMemoryProxy','Ext.util.TaskRunner'],
			controllers : ['GCP.controller.ReceivableInitiationController'],
			launch : function() {
