...
Ext.application({
			name : 'GCP',
			appFolder : 'static/scripts/collections/receivableSummaryQueryT7/app',
			requires : ['Ext.ux.gcp.PreferencesHandler',
					'Ext.ux.gcp.GroupView', 'GCP.view.ReceivableSummaryQueryView',
					'Ext.ux.gcp.vtypes.CustomVTypes'],
			controllers : ['GCP.controller.ReceivableSummaryQueryController'],
			...
			launch : function() {
				...
				objSummaryView = Ext.create('GCP.view.ReceivableSummaryQueryView', {
