...
Ext.application({
			name : 'GCP',
			appFolder : 'static/scripts/collections/receivableSummaryT7/app',
			requires : ['Ext.ux.gcp.PreferencesHandler', 'Ext.ux.data.PagingMemoryProxy',
					'Ext.ux.gcp.GroupView', 'GCP.view.ReceivableSummaryView',
			...
			launch : function() {
				...
				objSummaryView = Ext.create('GCP.view.ReceivableSummaryView', {
