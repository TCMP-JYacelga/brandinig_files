Ext.define('GCP.view.RecViewTxnFilterView', {
	extend : 'Ext.panel.Panel',
	xtype : 'recViewTxnFilterView',
	requires : ['Ext.panel.Panel', 'Ext.form.Label', 'Ext.toolbar.Toolbar',
			'Ext.Img', 'Ext.button.Button', 'GCP.view.RecAdvancedFilterPopup',
			'GCP.view.RecTxnCreateNewAdvFilter'],
	width : '100%',
	margin : '10 0 0 0',
	collapsible : true,
	...
	initComponent : function() {
		var me = this;
		me.objAdvFilterPopup = Ext.create('GCP.view.RecAdvancedFilterPopup', {
					parent : 'pmtTxnView',
					width : 710,
					height : 565,
					tapPanelWidth : 690,
					...
					filterPanel : {
						xtype : 'recTxnCreateNewAdvFilter',
						margin : '2 0 0 0',
						listeners : {
		...
		var gridView = firstTab.down('recSummaryAdvFilterGridView');
		
		advFilterTabPanelRef.setActiveTab(1);
		var secondTab = advFilterTabPanelRef.getActiveTab();
		var advFilterPanel=secondTab.down('recTxnCreateNewAdvFilter');
	...
	tools : [{
			...
			editFilterData : function(grid, rowIndex) {
				...
				var advFilterPanelRef = advanceFilterPopupRef.down('recTxnCreateNewAdvFilter');
				var advFilterTabPanelRef = advanceFilterPopupRef.down('tabpanel[itemId="advancedFilterTab"]');
				advFilterTabPanelRef.setActiveTab(1);	
	...
	populateAndDisableSavedFilter : function(filterCode,filterData,applyAdvFilter) {
		...
		var buttonText='';
		var advanceFilterPopupRef = me.objAdvFilterPopup;
		var advFilterPanelViewRef = advanceFilterPopupRef.down('recTxnCreateNewAdvFilter');
...
//					console.log('Bad : Something went wrong with your request');
	...
	populateSavedFilter : function(filterCode, filterData, applyAdvFilter) {
		...
		var buttonText='';
		var advanceFilterPopupRef = me.objAdvFilterPopup;
		var objCreateNewFilterPanel = advanceFilterPopupRef.down('recTxnCreateNewAdvFilter');
	...
	handleProductActionsAndPaymentTypeLoading : function() {
		...
		var strUrl = 'services/paymentheaderinfo('+ strParentId  +').json?'+csrfTokenName+'=' + tokenValue;
			Ext.Ajax.request({
