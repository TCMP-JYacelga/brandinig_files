Ext.define('GCP.view.MandateSetupGridView', {
	extend : 'Ext.panel.Panel',
	requires : ['Ext.ux.gcp.SmartGrid','GCP.view.MandateGroupActionBarView','Ext.panel.Panel'],
	xtype : 'mandateSetupGridView',
	width : '100%',
	cls:'xn-ribbon',
	initComponent : function() {
		var me = this;
		var actionBar = Ext.create('GCP.view.MandateGroupActionBarView', {
		...
		this.items = [{
			...
			width : '100%',
			collapsible : true,	
			title : getLabel('mandateList', 'Mandate List'),
			autoHeight : true,
