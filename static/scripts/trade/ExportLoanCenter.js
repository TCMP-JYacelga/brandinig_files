function changeSortLoan(sortCol, sorOrd, colId)
{
	...
	if(!isEmpty(colId))
	{
		...
		frm.action = "sortExportBillLoanList.form";
		frm.target = "";
		frm.method = "POST";
		frm.submit();		
	}
...
function filterLoans(frmId)
{
	...
	frm.action = "advanceFilterExportBillLoan.form";
	frm.target = "";
	frm.method = "POST";
	frm.submit();	
}
...
function simpleLoanFilter(frmId)
{
	...
	frm.action = "simpleFilterExportBillLoan.form";
	frm.target = "";
	frm.method = "POST";
	frm.submit();	
}
...
function viewLoanData(frmId, rowIndex)
{
	...
	frm.action = "viewExportBillLoan.form";
	frm.target = "";
	frm.method = "POST";
	frm.submit();
}
function authorizeLoan(frmId)
{
	...
	frm.action = "authorizeExportBillLoan.form";
	frm.target = "";
	frm.method = "POST";
	frm.submit();
}
...
function rejectLoan(frmId) 
{
	...
	document.getElementById("hiddenLoanRef").value = selectedLoanCheckBox;
	frm.action = "rejectExportBillLoan.form";
	frm.target = "";
	frm.method = "POST";
	frm.submit();
}
...
{	
	frm = document.getElementById(frmId);
	document.getElementById("hiddenLoanRef").value = selectedLoanCheckBox;
	frm.action = "deleteExportBillLoan.form";
	frm.target = "";
	frm.method = "POST";
	frm.submit();
}
...
{	
	frm = document.getElementById(frmId);
	document.getElementById("hiddenLoanRef").value = selectedLoanCheckBox;
	frm.action = "sendExportBillLoan.form";
	frm.target = "";
	frm.method = "POST";
	frm.submit();
}
...
function getLoanHistoryPopUp(frmId, rowIndex)
{
	var frm = document.getElementById(frmId);
	document.getElementById("txtRecordIndex").value = rowIndex;
	frm.action = "exportBillLoanHistory.hist";
	frm.target = "hWinSeek";
	frm.method = "POST";
	var strAttr;
...
function changeLoanPage(navType, newPage) 
{
	...
	{
		case 'first':
			frm.action = 'exportBillLoanCenter_first.form';
			break;
		case 'prev':
			frm.action = 'exportBillLoanCenter_previous.form';
			break;
		case 'next':
			if(curPage>=totPage)
				  return false;
			frm.action = 'exportBillLoanCenter_next.form';
			break;
		case 'last':
			frm.action = 'exportBillLoanCenter_last.form';
			break;
		case 'input':
			$('#page_number').val(curPage);
			frm.action = 'exportBillLoanCenter_goto.form';
			break;
		default:
