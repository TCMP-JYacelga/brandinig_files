...
{
	if (me.className.startsWith(" grey"))
		return;
	var frm = document.forms["frmMain"];
	if (document.getElementById("updateIndex").value == "")
	{
...
function getRejectRecord(me, rejTitle, rejMsg,strUrl)
{
	...
	if (temp.className.startsWith(" grey"))
		return;
	if (document.getElementById("updateIndex").value == "")
	{
		alert("Select Atlease One Record")
...
function selectRecord(ctrl, status, index, maker, validFlag)
{
	...
	if (lenDelimAction > 1)
	{
		...
		refreshButtons(maker, validFlag);
	}
	else
	{
...
function refreshButtons(maker, validFlag)
{
	...
	if (strActionButtons.length > 0)
	{
		for (i=0; i<5; i++)
		{
				switch (i)
				{
					...
					{
						document.getElementById("btnAuth").className =" black inline_block button-icon icon-button-accept font_bold";
					}
					else
					{
						document.getElementById("btnAuth").className =" grey inline_block button-icon icon-button-accept-grey font-bold";
					}
					break;					
					...
					if (strActionButtons.charAt(i)*1 ==1 &&  maker != _strUserCode)
					{
						document.getElementById("btnReject").className =" black inline_block button-icon icon-button-reject font_bold";
					}
					else
					{
						document.getElementById("btnReject").className =" grey inline_block button-icon icon-button-reject-grey font-bold";
					}
					break;
					
					case 2: 
					if (strActionButtons.charAt(i)*1 ==1 && "N" == validFlag)
					{
						document.getElementById("btnEnable").className =" black inline_block button-icon icon-button-enable font_bold";
					}
					else
					{
						document.getElementById("btnEnable").className =" grey inline_block button-icon icon-button-enable-grey font-bold";
					}
					break;
					
					case 3: 
					if (strActionButtons.charAt(i)*1 ==1 && "Y" == validFlag)
					{
						document.getElementById("btnDisable").className =" black inline_block button-icon icon-button-disable font_bold";
					}
					else
					{
						document.getElementById("btnDisable").className =" grey inline_block button-icon icon-button-disable-grey font-bold";
					}
					break;
					...
					{
						document.getElementById("btnDiscard").className =" black inline_block button-icon icon-button-discard font_bold";
					}
					else
					{
						document.getElementById("btnDiscard").className =" grey inline_block button-icon icon-button-discard-grey font-bold";
					}
					break;
				}
		}
