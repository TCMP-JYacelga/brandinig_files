...
function showAddNewForm(frmId, rowIndex)
{
	...
	frm.action = "addLCTemplateMasterController.form";
	frm.target = "";
	frm.method = "POST";
	frm.submit();
}
...
jQuery.fn.productPopupClientAutoComplete = function() {
		...
		$(this).autocomplete({
					...
					select : function(event, ui) {
						...
						if (data) {
							...
							{
								$('#addLCTemplateClientDesc').val(data.DESCR);
								$('#addLCTemplateClientCode').val(data.CODE);
							}
