	...
	if (strActionButtons.length > 0)
	{
		for (i=0; i<5; i++)
		{
				switch (i)
				{
					...
					if (strActionButtons.charAt(i)*1 ==1 &&  maker != _strUserCode)
					{
						document.getElementById("btnReject").className =" black inline_block ux_font-size14-normal button-icon icon-button-reject font_bold";
					}
					else
					{
						document.getElementById("btnReject").className =" grey inline_block ux_font-size14-normal button-icon icon-button-reject-grey font-bold";
					}
					break;
