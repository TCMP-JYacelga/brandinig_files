...
Ext.application({
	...
	requires : [ 'Ext.ux.gcp.PreferencesHandler', 'Ext.ux.data.PagingMemoryProxy', 'Ext.ux.gcp.GroupView',
			'GCP.view.VirtualAccMaintSummaryView', 'Ext.ux.gcp.vtypes.CustomVTypes' ],
	controllers : [ 'GCP.controller.VirtualAccMaintController' ],
	...
	launch : function() {
		...
		objSummaryView = Ext.create('GCP.view.VirtualAccMaintSummaryView', {
