widgetMetaData.paymentBarChart = function(widgetId, widgetType)
{
	var metadata = {
  "title": getDashLabel('payables.title'),
  "desc": getDashLabel('payables.title'),
  "type": "chart",
  "subType": "barchart", 
  ...
  "chart":{
	  ...
	  "onclick" : function(data){
		  let selectedData = data.points[0].label;
		  $.publish('com.finastra.widget.filter.top5PayablesBarChart',selectedData);
	  }
  },
 "actions":{},
  "filter" : {
