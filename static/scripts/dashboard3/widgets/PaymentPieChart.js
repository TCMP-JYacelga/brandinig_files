widgetMetaData.paymentPieChart = function(widgetId, widgetType)
{
	var metadata = {		
  "title": getDashLabel('payments.pieChart.title'),
  "desc": getDashLabel('payments.pieChart.desc'),
  "type": "chart",
  "subType": "piechart", 
  ...
  "chart":{
	  ...
	  "yAxis" : "record.amount",
	  "legend" : "record.productCategoryDesc",
	  "yAxisLable" : getDashLabel('payments.amount'),
	  "charttitle": getDashLabel('payments.pieChart.chartTitle')
  },
 "actions":{},
 "filter" : {
      "fields": [
