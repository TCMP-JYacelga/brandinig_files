		...
		'GCP.controller.BandInfoController',
		{
			...
			getBandInfoConfiguration : function()
			{
				...
				arrColsPref =
					[
						...
						{
							"colId" : "bandType",
							"colDesc" : getLabel( 'bandType', 'Type' )
						},
						{
							"colId" : "parentBand",
				...
				if($('#fileFormat').val() == 'XLSX')
				{
					...
					[
						...
						{
							"colId" : "relativeXpath",
							"colDesc" : getLabel( 'sheetName', 'Sheet Name' )
						},
						{
							"colId" : "startRow",
							"colDesc" : getLabel( 'startRow', 'Start Row' )
						},
						{
							"colId" : "endRow",
							"colDesc" : getLabel( 'endRow', 'End Row' )
						},
						{
							"colId" : "startColumn",
							"colDesc" : getLabel( 'startCol', 'Start Column' )
						},
						{
							"colId" : "endColumn",
							"colDesc" : getLabel( 'endCol', 'End Column' )
						}
					];
				}
				storeModel =
				{
					...
					[
						...
						'datastoreName','bandViewState','updateQuery','startRow','endRow','startColumn','endColumn'
					],
					proxyUrl : 'getUploadInterfaceBandDetailList.srvc',
					rootNode : 'd.bandInfo',
			...
			deleteAction : function()
			{
				...
				if( !Ext.isEmpty( grid ) )
				{
					...
					if( cloneRestrictedFlag == 'RESTRICTED_ENABLE' )
					{
						Ext.Msg.confirm( 'Delete Band', 'You are about to Delete Band for Clone restricted Interface. Later you cannot add the band. Do you want to Continue.....? ',
						function( id, value )
						{
							if( id === 'yes' )
							{
