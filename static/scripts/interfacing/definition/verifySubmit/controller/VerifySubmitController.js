Ext.define('GCP.controller.VerifySubmitController', {
	...
	formatDetailsViewRender : function() {
		...
		var lineOffsetStartFlag = formatDetailsView.down( 'panel[itemId="infoSummaryLowerPanel111"] panel label[itemId="lineOffSetStartFlag"]' );
		lineOffsetStartFlag.setText(lineOffSetStartFlagId);
		var lineOffsetValue = formatDetailsView.down( 'panel[itemId="infoSummaryLowerPanel111"] panel label[itemId="lineOffSetValue"]' );
		lineOffsetValue.setText(lineOffSetValueId);
	},
