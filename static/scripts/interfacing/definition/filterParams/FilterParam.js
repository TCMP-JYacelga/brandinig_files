...
function editFilterParamPopUp(record)
{
	...
	if( 'Internal' == parameterType || 'I' == parameterType )
	{
		$('#paramType').val('I');	
		setFilterList('I', 'parameterName');	
	}
	else if( 'External' == parameterType || 'E' == parameterType)
	{
		$('#paramType').val('E');	
		setFilterList('E', 'parameterName');	
	}
	if( 'Hidden' == parameterType || 'H' == parameterType)
	{
		$('#paramType').val('H');	
...
function updateFilterParam(addNew)
{
	...
	{
		frm.action = "updateFilterParameter.seek";
	}
	else
	{
...
function addFilterParam(addNew)
{
	...
	{
		frm.action = "saveFilterParameter.seek";
	}
	else
	{
		alert(type);
...
function deleteFilterParam(frmId)
{
	...
	{
		frm.action = "deleteFilterParameter.seek";
	}
	else
	{
		alert(type);
...
function viewFilterParameter(record)
{
	...
	if((record.get('parameterType') == 'External' || record.get('parameterType') == 'E') && record.get('dataType') != 'DATE' && record.derivation != 'N')
	{
		$('#vlblfieldListValueType').show();
		$('#vfieldListValueType').show();
	}
