/**
 * FilterParamsGroupActionBarView contains different buttons which are different group
 ...
 */
Ext.define( 'GCP.view.FilterParamsGroupActionBarView',
{
	extend : 'Ext.toolbar.Toolbar',
	xtype : 'filterParamsGroupActionBarView',
	enableOverflow : true,
	border : false,
	...
	initComponent : function()
	{
		...
		[
			...
			{
				text : getLabel( 'actionDeleteFilterParams', 'Delete' ),
				itemId : 'deleteBtn',
				disabled : true,
				actionName : 'delete',
				maskPosition : 3,
