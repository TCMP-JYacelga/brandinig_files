	...
	initComponent : function()
	{
		...
		this.items = [{
			...
			items: [{
			    ...
			    {
			    	xtype: 'checkbox',
	                boxLabel: getLabel( 'lblCloneRestrictedFlag', 'Restricted' ),
	                id: 'cloneRestrictedFlagChkBox',
	                handler: function()
	                {
	                	var checked = Ext.getCmp('cloneRestrictedFlagChkBox').getValue();
	                	me.fireEvent('handleCheckBoxCloneRestrictedFlagAction', checked);
	                }
			    }]
			}]
		}];
