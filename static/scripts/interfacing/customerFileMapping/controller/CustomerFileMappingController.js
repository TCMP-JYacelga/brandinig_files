Ext.define('GCP.controller.CustomerFileMappingController', {
	extend : 'Ext.app.Controller',
	views : ['GCP.view.CustomerFileMappingSummaryView', 'GCP.view.ShowClonePopUp',
			'GCP.view.CustomerFileMappingHistoryPopup', 'GCP.view.Widget'],
	refs : [{
				ref : 'customerFileMappingSummaryView',
				selector : 'customerFileMappingSummaryView'
			}, {
				ref : 'customerFileMappingSummaryFilterView',
				selector : 'customerFileMappingSummaryFilterView'
			}, {
				ref : 'customerFileMappingSummaryGridView',
				selector : 'customerFileMappingSummaryView customerFileMappingSummaryGridView'
			}, {
				ref : 'matchCriteria',
				selector : 'customerFileMappingSummaryView radiogroup[itemId="widgetMatchCriteria"]'
			}, {
				ref : 'searchTxnTextInput',
				selector : 'customerFileMappingSummaryView textfield[itemId="searchTxnTextField"]'
			}, {
				ref : 'btnSavePreferencesRef',
				selector : 'customerFileMappingSummaryView customerFileMappingSummaryFilterView button[itemId="btnSavePreferences"]'
			}, {
				ref : 'btnClearPreferences',
				selector : 'customerFileMappingSummaryView customerFileMappingSummaryFilterView button[itemId="btnClearPreferences"]'
			}, {
				ref : 'withHeaderCheckbox',
				selector : 'customerFileMappingSummaryView customerFileMappingSummaryTitleView menuitem[itemId="withHeaderId"]'
			}, {
				ref : 'customerFileMappingSummaryInfoView',
				selector : 'customerFileMappingSummaryInfoView'
			}, {
				ref : 'infoSummaryLowerPanel',
				selector : 'customerFileMappingSummaryInfoView panel[itemId="infoSummaryLowerPanel"]'
			}, {
				...
				selector : 'customerFileMappingSummaryView widgetContainer[itemId="moduleContainer"]'
			}, {
				ref : 'interfaceTypeToolBar',
				selector : 'customerFileMappingSummaryView customerFileMappingSummaryFilterView toolbar[itemId="interfaceTypeToolBar"]'
			}, {
				ref : 'flavorTypeToolBar',
				selector : 'customerFileMappingSummaryView customerFileMappingSummaryFilterView toolbar[itemId="flavorTypeToolBar"]'
			}, {
				ref : 'statusLabel',
				selector : 'customerFileMappingSummaryView customerFileMappingSummaryFilterView label[itemId="strStatusValue"]'
			}, {
				ref : 'taskStatusItemId',
				selector : 'customerFileMappingSummaryFilterView button[itemId="taskStatusItemId"]'
			}, {
				ref : 'sellerClientMenuBar',
				selector : 'customerFileMappingSummaryView customerFileMappingSummaryFilterView panel[itemId="sellerClientMenuBar"]'
			}, {
				ref : 'sellerMenuBar',
				selector : 'customerFileMappingSummaryView customerFileMappingSummaryFilterView panel[itemId="sellerMenuBar"]'
			}, {
				ref : 'clientMenuBar',
				selector : 'customerFileMappingSummaryView customerFileMappingSummaryFilterView panel[itemId="clientMenuBar"]'
			}, {
				ref : 'clientLoginMenuBar',
				selector : 'customerFileMappingSummaryView customerFileMappingSummaryFilterView panel[itemId="clientLoginMenuBar"]'
			},{
				ref : 'clientCodeCombo',
				selector : 'customerFileMappingSummaryView customerFileMappingSummaryFilterView combo[itemId="clientCodeComboId"]'
			},{
				ref : 'groupView',
				selector : 'customerFileMappingSummaryView groupView'
			},{
				ref:'filterView',
				selector:'filterView'
			},{
				ref : 'interfaceNameFltRef',
				selector : 'customerFileMappingSummaryView customerFileMappingSummaryFilterView combo[itemId="interfaceNameId"]'
			},{
				ref : 'statusFltRef',
				selector : 'customerFileMappingSummaryView customerFileMappingSummaryFilterView combo[itemId="statusFltId"]'
			},{
				ref : 'companyFltRef',
				selector : 'customerFileMappingSummaryView customerFileMappingSummaryFilterView combo[itemId="clientCombo"]'
			}
	...
	config : {
		...
		urlGridPref : 'userpreferences/customerFileMappingSummary/gridView.srvc?',
		urlGridFilterPref : 'userpreferences/customerFileMappingSummary/gridViewFilter.srvc?',
		commonPrefUrl : 'services/userpreferences/customerFileMappingSummary.json',
		sellerFilterVal : null,
		clientFilterVal : '',
		clientFilterDesc : null,
		strGetModulePrefUrl : 'services/userpreferences/customerFileMappingCenter/{0}.json',
		strDefaultMask : '0000',
		cfgGroupByUrl : 'services/grouptype/customerFileMappingCenter/groupBy.srvc?'+csrfTokenName+'='+tokenValue+'&$filter=seller eq '+'\''+'{0}'+'\'' + '&$filterscreen=BANKADMIN&$filterGridId=GRD_ADM_INTERFACECEN',
		cfgBankClientGroupByUrl : 'services/grouptype/customerFileMappingCenter/groupBy.srvc?'+csrfTokenName+'='+tokenValue+'&$filter=seller eq '+'\''+'{0}'+'\'' + '&$filterscreen=BANKCLIENT&$filterGridId=GRD_ADM_INTERFACECEN',
		cfgClientGroupByUrl : 'services/grouptype/customerFileMappingCenter/groupBy.srvc?'+csrfTokenName+'='+tokenValue+'&$filter=entityCode eq '+'\'{0}\' and seller eq '+'\'{1}\''+ '&$filterscreen=CLIENT&$filterGridId=GRD_ADM_INTERFACECEN',
		preferenceHandler : null,
		strPageName : 'customerFileMappingSummaryNewUX',
		filterDataPref : {},
		cloneRestrictedFlagChkBoxVal : 'RESTRICTED_DISABLE',
		statusFilterVal : 'all',
		statusFilterDesc : 'All',
		isInterfaceName : false,
		oldInterfaceName : ''
	},
	/**
	...
	init : function() {
		...
		$(document).on('createCustomInterface',function(event){
					var filter= me.getCustomerFileMappingSummaryFilterView();
					if(!Ext.isEmpty(filter)){
						doChooseInterface( filter.seller, filter.clientCode, filter.clientDesc );
					}else{
						doChooseInterface(strSeller,strClient,strClientDesc );
					}
				});
		...
		me.objClonePopup = Ext.create('GCP.view.ShowClonePopUp', {
					parent : 'customerFileMappingSummaryView',
					itemId : 'clonePopUpId'
				});
		...
		me.control({
			...
			'customerFileMappingSummaryView' : {
				beforerender : function(panel, opts) {
				},
				afterrender : function(panel, opts) {
				}
			},
			'customerFileMappingSummaryView textfield[itemId="searchTxnTextField"]' : {
				change : function(btn, opts) {
					me.searchTrasactionChange();
				}
			},
			'customerFileMappingSummaryView radiogroup[itemId="widgetMatchCriteria"]' : {
				change : function(btn, opts) {
					me.searchTrasactionChange();
				}
			},
			/*'customerFileMappingSummaryView customerFileMappingSummaryFilterView button[itemId="btnSavePreferences"]' : {
			...
			'customerFileMappingSummaryView customerFileMappingSummaryFilterView button[itemId="btnClearPreferences"]' : {
				click : function(btn, opts) {
					me.toggleSavePrefrenceAction(false);
					me.handleClearPreferences();
			...
			'customerFileMappingSummaryView customerFileMappingSummaryTitleView' : {
			...
			'customerFileMappingSummaryView customerFileMappingSummaryInfoView panel[itemId="customerFileMappingSummaryInfoHeaderBarGridView"] image[itemId="summInfoShowHideGridView"]' : {
			...
			'customerFileMappingSummaryInfoView' : {
			...
			'customerFileMappingSummaryView customerFileMappingSummaryFilterView toolbar[itemId="statusToolBar"]' : {
				afterrender : function(tbar, opts) {
					me.updateStatusFilterView();
				}
			},
			'customerFileMappingSummaryView customerFileMappingSummaryFilterView button[itemId="filterBtnId"]' : {
				click : function(btn) {
					me.applySeekFilter();
				}
			},
			'customerFileMappingSummaryView groupView' : {				
			...
			'customerFileMappingSummaryFilterView' : {	
			...
			'customerFileMappingSummaryView groupView smartgrid' : {
			...
			'customerFileMappingSummaryFilterView  combo[itemId="statusFltId"]' : {
			...
			'customerFileMappingSummaryFilterView AutoCompleter[itemId="interfaceNameId"]' : {
				select : function(combo, record, index) {
					me.applySeekFilter();
					me.disablePreferencesButton("savePrefMenuBtn",false);
					me.disablePreferencesButton("clearPrefMenuBtn",false);	
					me.isInterfaceName = true;
				},
				change : function(combo, record, index, oldValue) {
					me.oldInterfaceName = oldValue;
					if (record == null) {
						me.applySeekFilter();
						me.disablePreferencesButton("savePrefMenuBtn",false);
						me.disablePreferencesButton("clearPrefMenuBtn",false);	
				...
				keyup : function(combo, e, eOpts){
					me.isInterfaceName = false;
				},
				blur : function(combo, record, index) {
					if (me.isInterfaceName == false && me.oldInterfaceName != combo.getRawValue()){
						me.applySeekFilter();
					}
					me.oldInterfaceName = 	combo.getRawValue();
				}
			},
			'customerFileMappingSummaryFilterView combo[itemId="clientCombo"]' : {
				select : function(combo, record, index) {
					me.applySeekFilter();
					me.disablePreferencesButton("savePrefMenuBtn",false);
					me.disablePreferencesButton("clearPrefMenuBtn",false);	
	...
	doHandleRowActions : function(actionName, grid, record, rowIndex){
		...
		else if(actionName === 'btnSecurityProfile')
		{
			me.selectSecurityProfile(record, null);
		}
		else if(actionName === 'customInterfaceApprove' || actionName === 'customInterfaceReject' || actionName === 'customInterfaceDiscard' || 
				actionName === 'customInterfaceEnable' || actionName === 'customInterfaceDisable' )
		{
	...
	doHandleGroupTabChange : function(groupInfo, subGroupInfo, tabPanel,
		...
		if(groupInfo){
			if (groupInfo.groupTypeCode == 'ADV_FILTER') {
				...
				//strUrl = "services/userpreferences/customerFileMappingCenter/all.json";
	...
	postDoHandleGroupTabChange : function(data, args, isSuccess) {
		...
		var me = args.scope;
		var objGroupView = me.getGroupView();
		var objSummaryView = me.getCustomerFileMappingSummaryView(), objPref = null, gridModel = null, intPgSize = null,showPager = true, heightOption = null;;
	...
	doHandleGroupActions : function(strAction, grid, arrSelectedRecords,
		...
		// customerFileMappingSummaryWidget, record );
		if (strAction === 'customInterfaceReject') {
			
			if(strActionType == 'rowAction')
			{
			...
			if(strActionType == 'rowAction')
			{
				me.doAction(strActionUrl, '', grid, arrSelectedRecords);
			}
			else
			{
	...
	setButtonCls : function(btn, itemId) {
		var me = this, filter = me.getCustomerFileMappingSummaryFilterView();
	...
	showRejectVerifyPopUp : function(strAction, strActionUrl,
			customerFileMappingSummaryWidget, arrSelectedRecords) {
		var me = this;
	...
	doAction : function(strActionUrl, remark, customerFileMappingSummaryWidget, arrSelectedRecords) {
		var me = this;
		var groupView = me.getGroupView();
		var objGroupView = me.getGroupView();
		if (!Ext.isEmpty(customerFileMappingSummaryWidget)) {
				var grid = customerFileMappingSummaryWidget;	
				var arrayJson = new Array();
				if(arrSelectedRecords == null )
				{
	...
	doRejectAction : function(strActionUrl, remark, customerFileMappingSummaryWidget,
			arrSelectedRecords) {
		var me = this;
		var groupView = me.getGroupView();
		var objGroupView = me.getGroupView();
	...
	preHandleGroupActions : function(strUrl, remark, customerFileMappingSummaryWidget,
			record) {
		var me = this;
		var grid = this.getCustomerFileMappingSummaryGridView();
		if (!Ext.isEmpty(grid)) {
			var arrayJson = new Array();
			var records = grid.getSelectedRecords();
	...
	enableDisableGroupActions : function(actionMask, customerFileMappingSummaryWidget) {

		var actionBar = customerFileMappingSummaryWidget.down(Ext.String.format(
				'toolbar[itemId="customerFileMappingGroupActionBarView_{0}"]',
				customerFileMappingSummaryWidget.widgetCode));
	...
	/*applyFilter : function() {
		var me = this;
		var grid = me.getCustomerFileMappingSummaryGridView();
		if (!Ext.isEmpty(grid)) {
			...
			strUrl = strUrl + me.getFilterUrl() + '&' + csrfTokenName + '='
					+ csrfTokenValue;
			me.getCustomerFileMappingSummaryGridView().setLoading(true);
	...
	*/
	handleLoadGridData : function(groupInfo, subGroupInfo, grid, url, pgSize,
		...
		if(!Ext.isEmpty(me.filterData)){
				if(!Ext.isEmpty(me.filterData) && me.filterData.length >= 1){
					arrOfParseQuickFilter = generateCustFileMappingFilterArray(me.filterData);
				}
		}
		...
		grid.on('cellclick', function(tableView, td, cellIndex, record, tr, rowIndex, e) {
			...
			if(columnType !== 'actioncontent' && columnType !== 'checkboxColumn' && clickedColumn.dataIndex != 'securityProfileId') {
				me.handleGridRowClick(record, grid);
			}
		});
		
	},
	handleGridRowClick : function(record, grid) {
		var me = this;
	...
	generateFilterUrl : function(groupInfo, subGroupInfo) {
		var me = this;
		var filterView = me.getCustomerFileMappingSummaryFilterView();
	...
	generateWidgetUrl : function(groupInfo, subGroupInfo) {
		...
		{
			if(!Ext.isEmpty(groupInfo) && !Ext.isEmpty(groupInfo.groupTypeCode) && groupInfo.groupTypeCode =='INTERFACECEN_OPT_MODULE')
				var strWidgetFilter = 'module_code' + ' eq ' + '\'' + subGroupInfo.groupCode + '\'';
			else			
				strWidgetFilter = strGroupQuery;
		}
	...
	getQuickFilterQueryJson : function() {
		var me = this;
		var statusFilterVal = null, statusFilterDisc = null ;
		...
		var jsonArray = [];
        var sellerCodeValue=null, customerFileMappingSummaryFilterView = me.getCustomerFileMappingSummaryFilterView();
		var userStatusFltId = customerFileMappingSummaryFilterView.down('combobox[itemId=statusFltId]');
		var interfaceNameFltId = customerFileMappingSummaryFilterView.down('combobox[itemId=interfaceNameId]');
		var companyNameFltId = customerFileMappingSummaryFilterView.down('combobox[itemId=clientCombo]');
		var companyName = null, companyDesc = null;
		if (!Ext.isEmpty(interfaceNameFltId)
					&& !Ext.isEmpty(interfaceNameFltId.getValue())) {
				interfaceName = interfaceNameFltId.getValue().toUpperCase();
			}
		
		if (interfaceName != null && interfaceName !== 'All' && interfaceName != '') {
			jsonArray.push({
						paramName : 'interfaceName',
						paramValue1 : encodeURIComponent(interfaceName.trim().replace(new RegExp("'", 'g'), "\''")),
						operatorValue : 'lk',
						dataType : 'S',
						paramFieldLable : getLabel('interface', 'Interface Name')
					});
		}
		if (!Ext.isEmpty(userStatusFltId)
				...
				statusFilterVal = userStatusFltId.getValue();
				statusFilterDisc = userStatusFltId.getRawValue();
		}
		...
		if (statusFilterVal != null && statusFilterVal != 'All'
			&& statusFilterVal != 'all' && statusFilterVal.length >= 1) {
				...
				if (statusFilterDisc != null && statusFilterDisc != 'All'
					...
					var objArray = statusFilterValArray.split(',');
		...
		if (!Ext.isEmpty(companyNameFltId)
				&& !Ext.isEmpty(companyNameFltId.getValue())) {
			companyName = companyNameFltId.getValue().toUpperCase();
			companyDesc = companyNameFltId.getRawValue();
		}
		if (companyName != null && companyName !== 'All' && companyName != '') {
			jsonArray.push({
						paramName : 'clientCode',
						paramValue1 : encodeURIComponent(companyName.trim().replace(new RegExp("'", 'g'), "\''")),
						operatorValue : 'lk',
						dataType : 'S',
						displayType : 5,
						paramFieldLable : getLabel('companyName', 'Company Name'),
						displayValue1 : companyDesc
					});
		}
		return jsonArray;
	},
	...
	enableValidActionsForGrid : function(customerFileMappingSummaryWidget, grid,
		...
		actionMask = doAndOperation(maskArray, 10);
		me.enableDisableGroupActions(actionMask, customerFileMappingSummaryWidget);
	},
	setInfoTooltip : function() {
		var me = this;
		var infotip = Ext.create('Ext.tip.ToolTip', {
			target : 'customerFileMappingSummaryFilterView-1034_header_hd-textEl',
			listeners : {
...
/*	postHandleSavePreferences : function(data, args, isSuccess) {
				...
				case 'statusFilterOp' :
					...
					for (var i = 0; i < objArray.length; i++) {
							...
							if(objArray[i] == 12){
								...
								strTemp = strTemp + "(requestState eq 3 and customInterfacevalidFlag eq 'Y')";
							}
							else if(objArray[i] == 11){
								strTemp = strTemp + "(requestState eq 3 and customInterfacevalidFlag eq 'N')";
							}
		...
		if (!Ext.isEmpty(objGridViewFilterPref)) {
			...
			if (!Ext.isEmpty(me.interfaceTypeFilterVal)
				...
				arrJsn.push({
							...
							paramValue1 : encodeURIComponent(me.interfaceTypeFilterVal.replace(new RegExp("'", 'g'), "\''")),
							operatorValue : 'eq',
							dataType : 'S'
						});
			}
			if (!Ext.isEmpty(me.flavorTypeFilterVal)
				...
				arrJsn.push({
							...
							paramValue1 : encodeURIComponent(me.flavorTypeFilterVal.replace(new RegExp("'", 'g'), "\''")),
							operatorValue : 'eq',
							dataType : 'S'
						});
			}
	...
	onUploadSummaryInformationViewRender : function() {
		var me = this;
		var accSummInfoViewRef1 = me.getCustomerFileMappingSummaryInfoView();
	...
	setSummaryInfo : function(grid) {
		...
		var customerFileMappingSummaryInfoView = me.getCustomerFileMappingSummaryInfoView();
		var standardCountId = customerFileMappingSummaryInfoView
				.down('panel[itemId="infoSummaryLowerPanel"] panel label[itemId="standardId"]');
		var customisedCountId = customerFileMappingSummaryInfoView
	...
	showHistory : function(record) {
		...
		var historyPopup =	Ext.create('GCP.view.CustomerFileMappingHistoryPopup', {
	...
	updateStatusFilterView : function() {
		...
		var objStatusLbl = {
			...
			'12' : getLabel('submittedRequestStatus', 'Submitted')
		};
	...
	getWidgetsData : function(objDefaultStandardViewPref) {
		var me = this;
		var strUrl = "customerFileMappingData.srvc?";
	...
	collapseWidget : function(customerFileMappingSummaryWidget) {
		// customerFileMappingSummaryWidget.setTitle( '<span
		// class="block ux_header-width ux-custom-header-font">'
		// + customerFileMappingSummaryWidget.widgetDesc + '</span>' );
	},
	...
	editAction : function(record, rowIndex) {
		...
		if (record.get('interfaceType') == 'Upload') {
			strUrl = "editCustomInterface.srvc";
		} else {
	...
	viewAction : function(record, rowIndex) {
		...
		var strUrl;
		if (record.get('interfaceType') == 'Upload') {
			strUrl = "viewCustomInterface.srvc";
		} else {
			strUrl = "viewCustomInterface.srvc";
		}
	...
	submitAction : function(record, rowIndex) {
		var strActionUrl = Ext.String.format('{0}.srvc', 'customInterfaceSubmit');
		var me = this;
		var groupView = me.getGroupView();
		var objGroupView = me.getGroupView();
		if (true) {
	...
	handleSecurityProfileLoading : function(record) {
		...
		document.getElementById('interfaceCode').value = record
				.get('interfaceName');
		$('#interfaceTextField').text(record.get('interfaceName'));
		$('#interfaceTextField').attr('title',record.get('interfaceName'));
		...
		if (entityType != 'BANK') {
			...
			strUrl = 'getBankSecurityProfile.srvc?' + csrfTokenName + '=' + csrfTokenValue;
		}
			Ext.Ajax.request({
						url : strUrl,
						method : "POST",
	 ...
	 var me=this;
	 var custFilterView = me.getCustomerFileMappingSummaryFilterView();
		var interfaceNameId = custFilterView
				.down('AutoCompleter[itemId=interfaceNameId]');
		
		interfaceNameId.setValue("");
	
		
		var statusFltId = me.getStatusFltRef();
		statusFltId.reset();
		me.statusFilterVal = 'all';
		//me.statusFilterDesc = null;
		statusFltId.selectAllValues();

		var CompanyFltId = me.getCompanyFltRef();
		CompanyFltId.reset();
	...
	showPageSettingPopup : function() {
		...
		var cloneOfColumnObj = cloneObject(CLIENT_INTERFACE_GENERIC_COLUMN_MODEL);
		
		if(clientCount <= 1){
			if(!Ext.isEmpty(cloneOfColumnObj)){
				$.each(cloneOfColumnObj, function(index, cfg) {
					if (cfg.colId == 'clientDesc') {
						cloneOfColumnObj.splice(index,1);
					}
				});
			}
		}
	...
	resetFieldInQuickFilterOnDelete : function(objData){
		...
		if (strFieldName ==='interfaceName' && !Ext.isEmpty(me.getInterfaceNameFltRef())) {
			me.getInterfaceNameFltRef().setValue('');
		}
		if (strFieldName ==='category' && !Ext.isEmpty(me.getCategoryFltRef())) {
			me.getCategoryFltRef().setValue('All');
		}
		if (strFieldName ==='requestState' && !Ext.isEmpty(me.getStatusFltRef())) {
		...
		if (strFieldName ==='clientCode' && !Ext.isEmpty(me.getCompanyFltRef())) {
			me.getCompanyFltRef().setValue('');
		}
...
function saveSecurityProfile() {
	...
	var secProfId = document.getElementById("secProfName").value;
	var id = document.getElementById("viewStateSecProf").value;
	...
	frm
			.appendChild(createFormElement('INPUT', 'HIDDEN', 'secProfId',
					secProfId));
	frm
			.appendChild(createFormElement('INPUT', 'HIDDEN', 'processViewState',
					id));
	frm.action = "attachCustomerSecurityProfile.srvc";
	frm.method = "POST";
	$('SecurityProfileInnerPopUp').dialog('close');
	frm.submit();
}
function showSecurityProfilePopUp(securityProfileId) {
	...
	makeNiceSelect('secProfName',false);
	setTimeout(function() {autoFocusOnFirstElement(null, 'SecurityProfileInnerPopUp', true);}, 100);
