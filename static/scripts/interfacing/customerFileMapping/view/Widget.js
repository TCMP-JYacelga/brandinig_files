Ext.define('GCP.view.Widget', {
	...
	[
		...
		'GCP.view.CustomerFileMappingGroupActionBarView'
	],
	anchor : '100%',
	frame : true,
	closable : false,
	...
	viewSmartGrid.on( 'cellclick', function( view, td, cellIndex, record, tr, rowIndex, e, eOpts )
		...
		viewSmartGrid.store.on( 'load', function( store, records, options )
		{
			...
			if (!Ext.isEmpty(actionsForWidget)) {
				viewActionBar = Ext.create('GCP.view.CustomerFileMappingGroupActionBarView', {
		...
		var objActionCol = {
			...
			items : [
					...
					},
					{
						...
						itemId : 'clone',
						text : 	getLabel('actionClone', 'Copy Record'), 
