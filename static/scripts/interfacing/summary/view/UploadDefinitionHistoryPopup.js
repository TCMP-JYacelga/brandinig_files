 ...
 */
Ext.define('GCP.view.UploadDefinitionHistoryPopup', {
	...
	initComponent : function() {
		...
		if (Ext.isEmpty(this.historyUrl)) {
			...
			this.title = getLabel('uploadHistoryTitle', 'Import Interface History');
