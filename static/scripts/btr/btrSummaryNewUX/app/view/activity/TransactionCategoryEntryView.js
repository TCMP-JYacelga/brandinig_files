/**
 * @class GCP.view.activity.TransactionCategoryEntryView
 * @extends Ext.panel.Panel
 * @author Vinay Thube
 */
Ext.define('GCP.view.activity.TransactionCategoryEntryView', {
	extend : 'Ext.form.Panel',
	cls : 'form-pnl-cls',
	xtype : 'transactionCategoryEntryView',
	requires : ['GCP.view.activity.TransactionCategoryEntryGridView',
	...
	doSetTransactionCategoryFormFields : function(record) {
		var me = this;
