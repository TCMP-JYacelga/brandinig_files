/**
 * @class GCP.view.activity.popup.CheckPopUp
 * @extends Ext.window.Window
 * @author Vinay Thube
 */
Ext.define('GCP.view.activity.popup.CheckPopUp', {
	...
	showCheckImage : function(record) {
		...
		Ext.Ajax.request({
					url : 'services/btrActivities/'+summaryType+'/showChequeImage.json?checkDepositeNo='
							+ custRef,
					method : 'GET',
					async : false,
