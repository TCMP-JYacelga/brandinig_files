/**
 * @class GCP.view.summary.SummaryInformationTypeCodePopUpView
 * @extends Ext.window.Window
 * @author Vinay Thube
 */
Ext.define('GCP.view.summary.SummaryInformationTypeCodePopUpView', {
	extend : 'Ext.window.Window',
	requires : ['Ext.button.Button', 'Ext.form.Label',
			'Ext.ux.form.ItemSelector'],
	xtype : 'summaryInformationTypeCodePopUpView',
