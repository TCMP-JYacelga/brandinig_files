/**
 * @class SummaryTypeCodeSettingPopup.js
 * @extends Ext.window.Window
 * @author Shraddha Chauhan
 */

Ext.define('GCP.view.common.SummaryTypeCodeSettingPopup', {
	extend : 'Ext.window.Window',
	xtype : 'summaryTypeCodeSettingPopup',
	autoHeight : true,
	closeAction : 'destroy',
	...
	width : '60%',
	itemId : 'summaryTypeCodeSettingPopup',
	draggable : false,
	resizable : false,
	title : getLabel("settingsTypeCode", "Summary Information"),
	cfgPopUpData : {},
	...
	createFilterPanel : function() {
		...
		var objGeneralFilterPanel = Ext.create('Ext.container.Container', {
			...
			items : [{
				...
				items : [/*{
					xtype : 'container',
					itemId : 'disBalSummContainer',
					layout : 'vbox',
					flex : 1,
					items : [{
								xtype : 'label',
								text : getLabel('displayBalanceSummary', 'Display Balance Summary')
							}, {
								xtype : 'checkbox',
								itemId : 'disBalSummCheckBox',
								name : 'disBalSummCheckBox',
								inputValue : 'Y',
								width : 200
