/**
 * @class GCP.view.tranCategoryPopUpView
 * @extends Ext.window.Window
 * @author Shraddha Chauhan
 */
Ext.define('GCP.view.tranCategoryPopUpView', {
	extend : 'Ext.window.Window',
	xtype : 'tranCategoryPopUpView',
	itemId : 'transactionCategoryPopUpView',
	requires : ['GCP.view.tranCategoryGridView',
	            'GCP.view.tranCategoryEntryView', 'Ext.tab.Panel',
			'Ext.button.Button'],
	modal : true,
