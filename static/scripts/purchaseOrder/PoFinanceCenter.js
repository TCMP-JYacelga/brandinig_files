...
function enableDisableFINAuthorizeLink(isAuth)
{
	...
	if (authorizeValue == true  && CAN_AUTH=='true') 
	{
		...
		$('#btnAuth').click(function()
				{authorizeFinance('authPoFinance.form','frmMain');});
	}
	else 
	{
		$('#btnAuth').removeAttr('onclick').click(function() 
...
function enableDisableFINRejectLink(isAuth)
{
	...
	if (rejectValue == true && CAN_AUTH=='true') 
	{
		...
		$('#btnReject').click(function()
				{
			getFinanceRejectPopup('rejectPoFinance.form','frmMain');
				});
	} 
	else
	{
...
function enableDisableFINSendLink()
{
	...
	if (sendValue == true && (CAN_EDIT=='true' || CAN_AUTH=='true'))
	{
		...
		{
			sendFinance('sendPoFinance.form','frmMain');
		});
	}
	else
	{
...
function enableDisableFINDeleteLink()
{
	...
	if (deleteValue == true && CAN_EDIT=='true') 
	{
		...
		{
			deleteFinance('deletePoFinance.form','frmMain')
		});
	} 
	else
	{
...
function poFinanceFilter(strUrl, frmId)
{
	 var frm = document.getElementById(frmId);
...
jQuery.fn.clientCodeFinSeekAutoComplete= function() {
	return this.each(function() {
		$(this).autocomplete({
					...
					select : function(event, ui) {
						...
						poFinanceFilter('poSimpleFilterFinance.form','frmMain'); 
					},
					open : function() {
