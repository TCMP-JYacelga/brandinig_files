...
Ext.define('GCPA.view.HistoryPopup', {
	...
	initComponent : function() {
		...
		var feeProfileName = getLabel('feeProfileName', 'Fee Profile Name')
		var histTitle = getLabel('AdminFeeHistory', 'Admin Fee History');
	...
	loadHistoryData : function(historyUrl, id) {
		...
		Ext.Ajax.request({
		//	url : historyUrl,
			url : 'cpon/common/history.json' + '?&' + '$histSeekPageId=history.seek.adminfee',
			method : 'POST',
