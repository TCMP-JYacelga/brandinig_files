Ext.define('Cashweb.controller.DailyPaymentStatusController', {
			extend : 'Ext.app.Controller',
			views : ['portlet.DailyPaymentStatus'],
			stores : ['DailyPaymentStatusStore'],
			models : ['DailyPaymentStatusModel'],
			mask : null,
			refs : [{
						ref : 'summaryPortlet',
						selector : 'dailypaymentstatus'
					}],
			init : function() {
				var me = this;
				this.control({
