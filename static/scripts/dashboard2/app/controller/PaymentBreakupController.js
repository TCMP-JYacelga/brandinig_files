Ext.define('Cashweb.controller.PaymentBreakupController', {
	extend : 'Ext.app.Controller',
	views : ['portlet.PaymentBreakup'],
	stores : ['PaymentBreakupStore'],
	models : ['PaymentBreakupModel'],
	mask : null,
	refs : [{
				ref : 'summaryPortlet',
				selector : 'paymentbreakup'
			}],
	init : function() {
		var me = this;
		this.control({
