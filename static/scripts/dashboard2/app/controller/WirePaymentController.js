Ext.define('Cashweb.controller.WirePaymentController', {
	extend : 'Ext.app.Controller',
	views : ['portlet.WirePayment'],
	stores : ['WirePaymentStore'],
	models : ['WirePaymentModel'],
	mask : null,
	refs : [{
				ref : 'wirePaymentPortlet',
				selector : 'wirepayment'
			}],
	init : function() {
		var me = this;
		this.control({
