Ext.define('Cashweb.view.portlet.HalfBanner2', {
	extend : 'Ext.panel.Panel',
	alias : 'widget.halfbanner2',
	border : false,
	//padding : '0 0 0 5',
	taskRunner : null,
	cols : 2,
	...
	initComponent : function() {
		...
		thisClass.on('afterrender', function() {
					...
					if (!Ext.isEmpty(thisClass.up('portlet2'))) {
					...
					//			}
					//		});
					$(document).on('closebanner1', function(event) {
								if (!Ext.isEmpty(thisClass.up('panel'))) {
	...
	loadImages : function(width) {
		...
		Ext.Ajax.request({
			...
			success : function(response) {
				...
				arrStrHtml
						.push("<div id='closeicon2' style='display:none'><img src='static/images/T7/close-circle.png' style='position:absolute; top:7px; left:97%;'  onclick='closeBanner(1)'></img></div>");
				arrStrHtml
