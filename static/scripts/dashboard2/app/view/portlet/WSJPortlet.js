Ext.define('Cashweb.view.portlet.WSJPortlet', {
		...
		listeners: {
			...
			'boxready': {
				fn: function(panel, width, height, eopts) {
					...
					panel.update('<iframe frameborder="0" style="border:none" height=90% width=100% src="static/scripts/dashboard2/gadgets/wsj.jsp?height='+calculatedHeight+' &width='+width+'" ></iframe>');
				}
			},
	...
	portletRefresh: function() {
		this.update('<iframe frameborder="0" style="border:none" height=90% width=100% src="static/scripts/dashboard2/gadgets/wsj.jsp?height='+this.config.height+' &width='+this.config.width+'" ></iframe>');
	},
