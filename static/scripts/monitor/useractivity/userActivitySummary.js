...
var USER_ACTIVITY_GENERIC_COLUMN_MODEL = [
            {
				"colId" : "userCode",
				"colHeader" : getLabel('lbl.userActivity.grid.userCode', 'User Id')
			},
			{
				"colId" : "userName",
			...
			{
				"colId" : "logoutTime",
				"colHeader" : getLabel('lbl.userActivity.grid.lastLogoutTime', 'Last Logout Time')
			},
			{
				"colId" : "userType",
				"colHeader" : getLabel('lbl.userActivity.grid.ussrType', 'User Type')
...
var EVENTLOG_GENERIC_COLUMN_MODEL = [{
	"colId" : "eventTime",
	"colHeader" : getLabel('lbl.eventLog.grid.dateTime', 'Date Time'),
	width : 150,
	"hidden" : false
}, {
	"colId" : "userCode",
	"colHeader" : getLabel('lbl.eventLog.grid.User', 'User Id'),
	"hidden" : false
},
{
	"colId" : "userName",
...
if (!isClientUser()) {
	...
	USER_ACTIVITY_GENERIC_COLUMN_MODEL.push({
		"colId" : "ipAdress",
		"colHeader" : getLabel('lbl.eventLog.grid.ipAdress', 'IP Address'),
		"hidden" : true
	});
	USER_ACTIVITY_GENERIC_COLUMN_MODEL.push({
		"colId" : "remarks",
		"colHeader" : getLabel('lblremark', 'Remark'),
		"hidden" : true
	});
}
