/**
 * @class GCP.view.PaymentQueueActionBarView
 * @extends Ext.toolbar.Toolbar
 * @author Shraddha Chauhan
 * @author Vinay Thube
 */
Ext.define('GCP.view.PaymentQueueActionBarView', {
	extend : 'Ext.toolbar.Toolbar',
	xtype : 'paymentQueueActionBarView',
	enableOverflow : true,
	border : false,
	...
	getAvailableActions : function() {
		...
		if (!Ext.isEmpty(arrAvailableActions)) {
			for (var count = 0; count < arrAvailableActions.length; count++) {
				cfgAction = mapQueueActionModel[me.queueType]
						? mapQueueActionModel[me.queueType][arrAvailableActions[count]]
						: null;
				if (cfgAction) {
