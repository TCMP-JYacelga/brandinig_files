Ext.define( 'GCP.view.PaymentQueueAdvFilterGridView',{
		...
		[
			...
			{	
			  ...
			  renderer: function(value, metaData, record, rowIndex, colIndex, store){ 
			         return '<a class="linkbox seeklink" style="vertical-align:revert;" href="#" title="'+getLabel('view','View')+'"></a>'+' '+'<a class="grid-row-action-icon icon-edit" style="vertical-align:revert;" href="#" title="'+getLabel('edit','Edit')+'"></a>';
				  }
			},
			{
			...
			},
			{
				...
				width : 150,
				renderer: function(){
					return '<span id="searchLink" class="small-button_underline thePoniter ux_font-size14-normal filterSearchLink cursor_pointer">'
