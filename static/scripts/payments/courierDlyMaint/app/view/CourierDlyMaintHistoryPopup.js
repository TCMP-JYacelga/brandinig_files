/**
 * @class GCP.view.CourierDlyMaintHistoryPopup
 * @extends Ext.window.Window
 * @author Sumith Khandagle
 */
Ext.define('GCP.view.CourierDlyMaintHistoryPopup', {
	...
	initComponent : function() {
		var me = this;
        var couirerACKNmbrLbl = getLabel("couirerACKNmbr","Couirer ACK Number");
        var histTitle = getLabel('courierHist', 'Courier Delivery Maintenance History');
        if (Ext.isEmpty(me.historyUrl)) {
            ...
            me.items = [{
                ...
                items : [{
                    ...
                    text : couirerACKNmbrLbl + ' : ',
                    width : '100'
                }, {
                    xtype : 'label',
                    style : { fontWeight: 'normal !important' },
                    cls : 'ux_font-size14',
                    html : '&nbsp' + me.couirerACKNmbr,
                    width : '150'
                }]
            },{
                xtype : 'grid',
	...
	loadHistoryData : function(historyUrl, id) {
		...
		Ext.Ajax.request({
			url : 'cpon/common/history.json?' + csrfTokenName + '=' + csrfTokenValue
                + '&$histSeekPageId=history.seek.courierDlyMaint',
			method : 'POST',
