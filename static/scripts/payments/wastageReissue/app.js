...
Ext.application({
	name : 'GCP',
	appFolder : 'static/scripts/payments/wastageReissue/app',
	requires : [ 'Ext.ux.gcp.PreferencesHandler', 'Ext.ux.data.PagingMemoryProxy', 'Ext.ux.gcp.GroupView',
			'GCP.view.WastageReissueSummaryView', 'Ext.ux.gcp.vtypes.CustomVTypes' ],
	controllers : [ 'GCP.controller.WastageReissueController' ],
	...
	launch : function() {
		...
		objSummaryView = Ext.create('GCP.view.WastageReissueSummaryView', {
