/**
 * @class GCP.controller.StationeryCpuController
 * @extends Ext.app.Controller
 * @author Himanshu Dixit
 */
Ext.define('GCP.controller.StationeryCpuController', {
    extend : 'Ext.app.Controller',
    requires : ['Ext.util.Point','Ext.panel.Panel'],
    views : ['GCP.view.StationeryCpuView',
             'GCP.view.StationeryCpuFilterView',
             'GCP.view.StationeryCpuGridView',
             'GCP.view.StationeryCpuActionBarView',
             'GCP.view.StationeryCpuHistoryPopup'],
    
    refs : [{
            ref : 'stnryCpuView',
            selector : 'stationeryCpuView'
        },{
            ref : 'createNewToolBar',
            selector : 'stationeryCpuView stationeryCpuGridView toolbar[itemId="btnCreateNewToolBar"]'
        },{
            ref : 'stnryCpuFilterView',
            selector : 'stationeryCpuView stationeryCpuFilterView'
        },{
            ref : 'gridHeader',
            selector : 'stationeryCpuView stationeryCpuGridView panel[itemId="stnCpuDtlView"] container[itemId="gridHeader"]'
        },{
            ref : 'stnryCpuGridView',
            selector : 'stationeryCpuView stationeryCpuGridView grid[itemId="gridViewMstId"]'
        },{
            ref : 'stnryCpuGridDtlView',
            selector : 'stationeryCpuView stationeryCpuGridView panel[itemId="stnCpuDtlView"]'
        },{
            ref : 'grid',
            selector : 'stationeryCpuGridView smartgrid'
        },{
            ref : 'groupActionBar',
            selector : 'stationeryCpuView stationeryCpuGridView stationeryCpuActionBarView'
        },{
            ref : 'specificFilterPanel',
            selector : 'stationeryCpuView stationeryCpuFilterView panel container[itemId="specificFilter"]'
        },{
            ref : "sellerCombo",
            selector : 'stationeryCpuView stationeryCpuFilterView combobox[itemId="sellerCombo"]'
        },
        
        {
            ref : "requestBranchFilter",
            selector : 'stationeryCpuView stationeryCpuFilterView combobox[itemId="requestBranchFilter"]'
        },
        {
            ref : "productFilter",
            selector : 'stationeryCpuView stationeryCpuFilterView combobox[itemId="productFilter"]'
        },
        {
            ref : "statusFilter",
            selector : 'stationeryCpuView stationeryCpuFilterView combobox[itemId="statusFilter"]'
        },
        {
            ref : 'requestDateBtn',
            selector : 'stationeryCpuView stationeryCpuFilterView button[itemId="requestDateBtn"]'
        }, 
        {
            ref : 'requestDateLabel',
            selector : 'stationeryCpuView stationeryCpuFilterView label[itemId="requestDateLabel"]'
        },
        {
            ref : "referenceNoFilter",
            selector : 'stationeryCpuView stationeryCpuFilterView textfield[itemId="referenceNo"]'
        },
        {
            ref : 'downloadReport',
            selector : 'stationeryCpuView stationeryCpuTitleView menuitem[itemId="downloadReport"]'
        }],
    config : {
        filterData : [],
        clientSelected : false,
        requestBranchSelected : false,
    ...
    init : function() {
        ...
        me.control({
            'stationeryCpuView stationeryCpuFilterView' : {
                render : function() {
                    me.setInfoTooltip();
            ...
            'stationeryCpuView stationeryCpuGridView panel[itemId="stnCpuDtlView"]' : {
                render : function() {
                    me.handleGridHeader();
                }
            },
            'stationeryCpuGridView' : {
                render : function(panel) {
                    me.handleSmartGridConfig();
                }
            },
            'stationeryCpuGridView smartgrid' : {
            ...
            'stationeryCpuGridView toolbar[itemId=stationeryCpuActionBarView]' : {
                performGroupAction : function(btn, opts) {
                    me.handleGroupActions(btn);
                }
            },
            'stationeryCpuView stationeryCpuFilterView button[itemId="btnFilter"]' : {
            ...
            'stationeryCpuView stationeryCpuGridView toolbar[itemId="btnCreateNewToolBar"] button[itemId="btnStnCpuCreateNew"]' : {
                click : function() {
                     me.cDlyMaintSetupEntryAction();
                }
            },
            'stationeryCpuView stationeryCpuTitleView' : {
                'performReportAction' : function(btn) {
                     me.handleReportAction(btn);
             }
            },
            'stationeryCpuView stationeryCpuFilterView component[itemId="paymentRequestDataPicker"]' : {
                render : function() {
        ...
        Ext.create('Ext.tip.ToolTip', {
            ...
            listeners : {
                beforeshow : function(tip) {
                    ...
                    var branchFilter = me.getRequestBranchFilter();
                    ...
                    if (!Ext.isEmpty(branchFilter) && !Ext.isEmpty(branchFilter.getValue()))
                    	requestBranch = branchFilter.getRawValue();
                    else
                    	requestBranch = getLabel( 'all', 'All' );
                    ...
                    tip.update(getLabel('seller', 'Financial Institution') + ' : '
                            + sellerFilter + '<br/>'
                            + getLabel('requestBranchDesc', 'Request Branch') + ' : '
                            + requestBranch  + '<br/>'
    ...
    handleSpecificFilter : function() {
        ...
        var createRequestBranchAutocompleter = Ext.create('Ext.ux.gcp.AutoCompleter', {
            fieldCls : 'xn-form-text xn-suggestion-box ux_font-size14-normal',
            cls:'ux_font-size14-normal',
            width : 190,
            name : 'requestBranch',
            itemId : 'requestBranchFilter',
            cfgUrl : 'services/userseek/{0}.json',
            cfgProxyMethodType : 'POST',
            cfgQueryParamName : '$autofilter',
            cfgRecordCount : -1,
            matchFieldWidth:true,
            cfgSeekId : 'stationeryRequestBranch',
            enableQueryParam:false,
            cfgRootNode : 'd.preferences',
            cfgDataNode1 : 'DESCRIPTION',
            cfgKeyNode:'CODE',
            listeners:{
                'select' : function(combo, record) {
                    me.requestBranchSelected = true;
                },
                'change' : function(combo, record) {
                    me.requestBranchSelected = false;
                }
            }
        });
        var statusStore = Ext.create('Ext.data.Store', {
            ...
            proxy : {
                type : 'ajax',
                autoLoad : true,
                url : 'services/stationeryCpu/statusList.json?' + csrfTokenName + "=" + csrfTokenValue,
                actionMethods : {
                    read : 'POST'
                },
                reader : {
                        ...
                        },
                        {
                            ...
                            items : [{
                                xtype : 'label',
                                 ...
                                 width : 315,
                                 text : getLabel('requestBranchDesc','Request Branch'),
                                 cls : 'f13 ux_font-size14 ux_normalmargin-bottom'
                             }, createRequestBranchAutocompleter]
                         },
                         {
                            xtype : 'panel',
                            cls : 'xn-filter-toolbar',
    ...
    setDataForFilter : function() {
        ...
        var productCode = null, productDesc = null, requestBranchCode = null, requestBranchDesc = null, referenceNo = null;
        var jsonArray = [];
        var stnryCpuFilterView = me.getStnryCpuFilterView();
        if(!Ext.isEmpty(stnryCpuFilterView)){
            ...
            if(!Ext.isEmpty(branchFilter)){
                if(me.requestBranchSelected === true){
                	requestBranchCode = branchFilter.getValue();
                } else {
                	requestBranchDesc = branchFilter.getValue();
                }
            }
            ...
            if (!Ext.isEmpty(requestBranchCode)) {
                jsonArray.push({
                    paramName : 'requestBranchCode',
                    paramValue1 : encodeURIComponent(requestBranchCode.replace(new RegExp("'", 'g'), "\''")),
                    operatorValue : 'eq',
                    dataType : 'S'
                });
            }
        ...
        if (!Ext.isEmpty(requestBranchDesc)) {
            jsonArray.push({
                paramName : 'requestBranchDesc',
                paramValue1 : encodeURIComponent(requestBranchDesc.toUpperCase().replace(new RegExp("'", 'g'), "\''")),
                operatorValue : 'lk',
                dataType : 'S'
            });
        }
    ...
    handleGridHeader : function() {
        ...
        if(ACCESSNEW){
            ...
            createNewPanel.add({
                xtype : 'button',
                border : 0,
                text : getLabel('stnIndCreateNew', 'Create Stationery Indent'),
                cls : 'cursor_pointer ux_button-background ux_button-padding ux_button-background-color ux_button-s',
                glyph:'xf055@fontawesome',
                parent : this,
                itemId : 'btnStnCpuCreateNew'
            });
        }
    },
    handleSmartGridConfig : function() {
        var me = this;
        var stnryCpuGrid = me.getStnryCpuGridView();
        var objConfigMap = me.getCourierDlyMaintGridConfiguration();
        var arrCols = null;
        if (!Ext.isEmpty(stnryCpuGrid))
            stnryCpuGrid.destroy(true);
    ...
    getCourierDlyMaintGridConfiguration : function(){
        ...
        objWidthMap = {
            ...
            { 
                ...
                "colDesc" : getLabel("sentQuantity","Sent Quantity")
            },
            { 
            ...
            storeModel = {
                    fields : ['requestReferenceNo','requestBranchCode','requestBranchDesc','stateCode','stateDesc','productCode',
                          ...
                          'sellerId'],
                proxyUrl : 'services/stationeryCpu.json',
                rootNode : 'd.profile',
    ...
    createGroupActionColumn : function() {
        var objActionCol = {
            ...
            {
                text : getLabel('stnBranchActionDispatch', 'Dispatch'),
                itemId : 'dispatch',
                actionName : 'dispatch',
                maskPosition : 5
            }]
    ...
    handleSmartGridLoading : function(arrCols, storeModel) {
        ...
        var stnryCpuGridDtlView = me.getStnryCpuGridDtlView();
        stnryCpuGridDtlView.add(maintGrid);
        stnryCpuGridDtlView.doLayout();
    },
    ...
    handleRowIconClick : function(tableView, rowIndex, columnIndex, btn, event, record) {
        ...
        if (actionName === 'accept' || actionName === 'reject')
            ...
            me.submitExtForm('viewStationeryCpu.form', record, rowIndex);
        } else if (actionName === 'dispatch') {
            me.submitExtForm('dispatchStationeryCpu.form', record, rowIndex);
        }
    },
    handleGroupActions : function(btn, record) {
        ...
        var strAction = !Ext.isEmpty(btn.actionName)
                ? btn.actionName
                : btn.itemId;
        var strUrl = Ext.String.format('services/stationeryCpu/{0}.srvc?', strAction);
        if (strAction === 'reject') {
        ...
        if (!Ext.isEmpty(grid)) {
            ...
            Ext.Ajax.request({
                ...
                success : function(response) {
                    ...
                    me.enableDisableGroupActions('00000', true);
                    grid.refreshData();
                },
                failure : function() {
                    Ext.MessageBox.show({
    ...
    downloadReport : function(actionName) {
        ...
        var gridView = me.getStnryCpuGridView();
        var grid = me.getGrid();
        strExtension = arrExtension[actionName];
        strUrl = 'services/generateStationeryCpuReport';
        strUrl += '?$skip=1';
        me.setDataForFilter();
        strUrl = strUrl + me.getFilterUrl();
    ...
    showHistory : function(url, id, recordKeyNo) {
        Ext.create('GCP.view.StationeryCpuHistoryPopup', {
    ...
    cDlyMaintSetupEntryAction : function(){
        var me = this;
        var form;
        var strUrl = 'addStationeryCpu.form';
        form = document.createElement('FORM');
        form.name = 'frmMain';
        form.id = 'frmMain';
        form.method = 'POST';
