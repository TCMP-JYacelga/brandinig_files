Ext.define('GCP.view.PaymentInstQueryActionBarView', {
	extend : 'Ext.toolbar.Toolbar',
	xtype : 'paymentInstQueryActionBarView',
	enableOverflow : true,
	border : false,
	...
	getAvailableActions : function() {
		...
		if (!Ext.isEmpty(arrAvailableActions)) {
			for (var count = 0; count < arrAvailableActions.length; count++) {
				cfgAction = mapQueueActionModel[me.queueType] ? mapQueueActionModel[me.queueType][arrAvailableActions[count]]
						: null;
				if (cfgAction) {
