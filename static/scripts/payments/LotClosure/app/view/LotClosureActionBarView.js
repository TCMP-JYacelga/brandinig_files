Ext.define('GCP.view.LotClosureActionBarView', {
	extend : 'Ext.toolbar.Toolbar',
	xtype : 'LotClosureActionBarView',
	enableOverflow : true,
	border : false,
	...
	getAvailableActions : function() {
		...
		if (!Ext.isEmpty(arrAvailableActions)) {
			for (var count = 0; count < arrAvailableActions.length; count++) {
				cfgAction = mapLotClosureActionModel[arrAvailableActions[count]] ?
				            mapLotClosureActionModel[arrAvailableActions[count]] : null;
				if (cfgAction) {
