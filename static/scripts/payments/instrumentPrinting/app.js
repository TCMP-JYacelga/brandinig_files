...
Ext.application({
	name : 'GCP',
	appFolder : 'static/scripts/payments/instrumentPrinting/app',
	requires : [ 'Ext.ux.gcp.PreferencesHandler', 'Ext.ux.data.PagingMemoryProxy', 'Ext.ux.gcp.GroupView',
			'GCP.view.InstrumentPrintingSummaryView', 'Ext.ux.gcp.vtypes.CustomVTypes' ],
	controllers : [ 'GCP.controller.InstrumentPrintingController' ],
	...
	launch : function() {
		...
		objSummaryView = Ext.create('GCP.view.InstrumentPrintingSummaryView', {
