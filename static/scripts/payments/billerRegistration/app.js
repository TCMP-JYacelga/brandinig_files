...
Ext.application({
	name : 'GCP',
	appFolder : 'static/scripts/payments/billerRegistration/app',
	requires : [ 'Ext.ux.gcp.PreferencesHandler', 'Ext.ux.data.PagingMemoryProxy', 'Ext.ux.gcp.GroupView',
			'GCP.view.BillerRegistrationSummaryView', 'Ext.ux.gcp.vtypes.CustomVTypes' ],
	controllers : [ 'GCP.controller.BillerRegistrationController' ],
	...
	launch : function() {
		...
		objSummaryView = Ext.create('GCP.view.BillerRegistrationSummaryView', {
