/**
 * @class GCP.view.StationeryBranchHistoryPopup
 * @extends Ext.window.Window
 * @author Himanshu Dixit
 */
Ext.define('GCP.view.StationeryBranchHistoryPopup',{
    ...
    initComponent : function() {
        ...
        var histTitle = getLabel('stationeryReqHist', 'Stationery Indent Request History');
    ...
    loadHistoryData : function(id){
        ...
        Ext.Ajax.request({
            url : 'services/stationeryBranch/history.json?' + csrfTokenName + '=' + csrfTokenValue + '&$id=' +id +'&$type=BH',
            method : 'POST',
            async : false,
