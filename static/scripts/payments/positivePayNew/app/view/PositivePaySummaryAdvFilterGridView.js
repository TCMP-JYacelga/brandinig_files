Ext.define('GCP.view.PositivePaySummaryAdvFilterGridView', {
		...
		cellclick : function(view, td, cellIndex, record, tr, rowIndex, e,
           ...
           if(IconLinkClicked){
				...
				if(className=='grid-row-action-icon icon-edit'){
					...
					{	
						me.fireEvent('editGridFilterEvent',view,rowIndex);
					}
				}else if(className=='linkbox seeklink'){
					if(me.callerParent == 'positivePayView')
					{	
						me.fireEvent('viewGridFilterEvent',view,rowIndex);
					}
           ...
           var upDownIconLinkClicked = (e.target.tagName == 'I');	
				...
				var className = e.target.className;
				 if(className=='fa fa-caret-up'){
					if(me.callerParent == 'positivePayView')
					{	
						me.fireEvent('orderUpGridEvent',view,rowIndex,-1);
					}
	...
	initComponent:function(){
		  ...
		  if(me.callerParent == 'positivePayView')
		  {
			strUrl = 'userfilterslist/positivepayFilter.srvc';
		  }
