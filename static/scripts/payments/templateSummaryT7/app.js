var objSummaryView = null, prefHandler = null, paymentCategoryStore = null;
...
Ext.application({
			...
			requires : ['Ext.ux.gcp.PreferencesHandler',
					'Ext.ux.gcp.GroupView', 'GCP.view.PaymentSummaryView','Ext.ux.gcp.FilterView',
					'Ext.ux.gcp.vtypes.CustomVTypes'],
			controllers : ['GCP.controller.PaymentSummaryController'],
			...
			launch : function() {
				...
				objSummaryView = Ext.create('GCP.view.PaymentSummaryView', {
