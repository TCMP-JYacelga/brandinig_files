Ext
		.define(
				'GCP.view.WHTRefundGridView',
				{
					extend : 'Ext.panel.Panel',
					border : false,
					xtype : 'WHTRefundGridView',
					requires : [ 'GCP.view.WHTRefundActionBarView',
					...
					createActionBarViewforGrooup : function() {
						...
						if (!Ext.isEmpty(arrAvailableActions)
							...
							actionBar = Ext.create(
									'GCP.view.WHTRefundActionBarView', {
					...
					reconfigureGroup : function() {
						...
						var WHTRefundGridPanel = me
								.down('panel[itemId="WHTRefundGridPanel"]');
						WHTRefundGridPanel.removeAll();
					...
					createGroupView : function(showCheckBoxColumnFlg, arrCols,
						...
						var gridId = "GRD_WHT_REFUND";
						var service = "WHTREF";
						groupView = Ext.create('Ext.ux.gcp.GroupView', {
							cfgGroupByUrl : 'services/grouptype/WHTRefund/'
									+ service + '.json?$filterGridId=' + gridId
									+ '&$columnModel=true',
							cfgSummaryLabel : "WHT Refund",
					...
					createGroupActionColumn : function() {
						...
						if (!Ext.isEmpty(arrGroupAction)
							...
							for (var i = 0; i < arrGroupAction.length; i++) {
								cfgAction = mapWHTRefundActionModel[arrGroupAction[i]];
					...
					getGridModel : function() {
						...
						if (!Ext.isEmpty(WHTRefundPref))
							arrColsPref = WHTRefundPref;
						else
							arrColsPref = WHTRefundGridColumn || [];
						objConfigMap = {
					...
					columnRenderer : function(value, meta, record, rowIndex,
						...
						var strRetValue = "";
						if (colId === "col_instAmount" && Ext.isEmpty(value)
								&& !Ext.isEmpty(record.data.totalInstAmount)) {
							strRetValue = record.data.totalInstAmount;
						} else {
							strRetValue = value;
						}
						return strRetValue;
					...
					refreshData : function() {
						var me = this, grid = me
								.down('smartgrid[itemId="WHTRefundGrid"]');
						if (grid)
							grid.refreshData();
					},
