/**
 * @class GCP.controller.BankPreGeneratedReportController
...
Ext
	.define(
		'GCP.controller.BankPreGeneratedReportController',
		{
			...
			views :
			[
				'GCP.view.BankPreGeneratedReportView', 'Ext.ux.gcp.PreferencesHandler'
			],
			refs :
			[
				{
					ref : 'bankPreGeneratedReportViewRef',
					selector : 'bankPreGeneratedReportViewType'
				},
				{
					ref : 'bankPreGeneratedReportFilterViewRef',
					selector : 'bankPreGeneratedReportViewType bankPreGeneratedReportFilterViewType'
				},
				{
					ref : 'clientAutoCompleter',
					selector : 'bankPreGeneratedReportViewType bankPreGeneratedReportFilterViewType AutoCompleter[itemId="reportCenterClientId"]'
				},
				{
					ref : 'reportNameAutoCompleter',
					selector : 'bankPreGeneratedReportViewType bankPreGeneratedReportFilterViewType AutoCompleter[itemId="reportNameId"]'
				},
				{
					ref : 'sellerCombo',
					selector : 'bankPreGeneratedReportViewType bankPreGeneratedReportFilterViewType combobox[itemId="reportCenterSellerId"]'
				},
				{
					ref : 'groupView',
					selector : 'bankPreGeneratedReportViewType groupView'
				},
				{
					ref : 'smartgrid',
					selector : 'bankPreGeneratedReportViewType groupView smartgrid'
				},
				{
					ref : 'btnClearPreferences',
					selector : 'bankPreGeneratedReportViewType bankPreGeneratedReportFilterViewType button[itemId="btnClearPreferences"]'
				},
				{
					ref : 'btnSavePreferences',
					selector : 'bankPreGeneratedReportViewType bankPreGeneratedReportFilterViewType button[itemId="btnSavePreferences"]'
				},
				{
					ref : 'fromDateLabel',
					selector : 'bankPreGeneratedReportViewType bankPreGeneratedReportFilterViewType label[itemId="dateFilterFrom"]'
				}, 
				{
					ref : 'toDateLabel',
					selector : 'bankPreGeneratedReportViewType bankPreGeneratedReportFilterViewType label[itemId="dateFilterTo"]'
				}, 
				{
					ref : 'dateLabel',
					selector : 'bankPreGeneratedReportViewType bankPreGeneratedReportFilterViewType label[itemId="dateLabel"]'
				}, 
				{
					ref : 'entryDate',
					selector : 'bankPreGeneratedReportViewType bankPreGeneratedReportFilterViewType button[itemId="entryDate"]'
				}, 
				{
					ref : 'fromEntryDate',
					selector : 'bankPreGeneratedReportViewType bankPreGeneratedReportFilterViewType datefield[itemId="fromDate"]'
				}, 
				{
					ref : 'toEntryDate',
					selector : 'bankPreGeneratedReportViewType bankPreGeneratedReportFilterViewType datefield[itemId="toDate"]'
				}, 
				{
					ref : 'dateRangeComponent',
					selector : 'bankPreGeneratedReportViewType bankPreGeneratedReportFilterViewType container[itemId="dateRangeComponent"]'
				},
				{
					ref : 'clientFilterPanel',
					selector : 'bankPreGeneratedReportViewType bankPreGeneratedReportFilterViewType container[itemId=clientFilterPanel]'
				}
			],
			config :
			{
				...
				reportModule : '01',
				strDefaultMask : '0000',
				strPageName : 'bankPreGeneratedReport',
				filterDataPref : {},
				entityType : 'BANK',
				initialSmartGridRender : true,
				strGetModulePrefUrl : 'services/userpreferences/bankPreGeneratedReport/{0}.json',
				cfgSellerGroupByUrl : 'services/grouptype/bankPreGeneratedReport/groupBy.srvc?&$filter=seller eq ' + '\'' + '{0}' + '\' and seller eq ' + '\'' + '{1}'
					+ '\'&$filterscreen=BANKADMIN',
				cfgSellerClientGroupByUrl : 'services/grouptype/bankPreGeneratedReport/groupBy.srvc?&$filter=seller eq ' + '\'' + '{0}' + '\' and client eq ' + '\'' + '{1}\''
					+ ' and client lk ' + '\'' + '{2}'
					+ '\' and seller eq ' + '\'' + '{3}' + '\'&$filterscreen=BANKCLIENT'
			...
			init : function()
			{
				...
				me
					.control(
					{
						'bankPreGeneratedReportViewType bankPreGeneratedReportFilterViewType' :
						{
							'render' : function()
							{
								me.setInfoTooltip();
							...
							'quickFilterChange' : function( filterJson )
							{
								...
								if( me.getBankPreGeneratedReportViewRef() )
									me.getBankPreGeneratedReportViewRef().setLoading( true );
								me.applyQuickFilter();
							},
						...
						'bankPreGeneratedReportViewType' :
						{
							'deleteFavoriteRep' : me.deleteFavoriteRep,
							'addFavoriteRep' : me.addFavoriteRep
						},
						'bankPreGeneratedReportViewType groupView' :
						{
						...
						'bankPreGeneratedReportViewType groupView smartgrid' :
						{
						...
						'bankPreGeneratedReportViewType bankPreGeneratedReportFilterViewType button[itemId="btnSavePreferences"]' :
						{
						...
						'bankPreGeneratedReportViewType bankPreGeneratedReportFilterViewType button[itemId="btnClearPreferences"]' :
						{
							click : function( btn, opts )
							{
						...
						'bankPreGeneratedReportViewType bankPreGeneratedReportTitleViewType button[itemId="btnCreateReport"]' :
						{
							click : function( btn, opts )
							{
						...
						'bankPreGeneratedReportViewType bankPreGeneratedReportTitleViewType toolbar[itemId="dateToolBar"]' : {
							afterrender : function(tbar, opts) {
								me.updateDateFilterView();
							}
						},
						'bankPreGeneratedReportViewType bankPreGeneratedReportFilterViewType button[itemId="goBtn"]' : {
								click : function(btn, opts) {
			...
			filterEntityType : function(entityType){
				var me = this;
				var filter = me.getBankPreGeneratedReportFilterViewRef() ;
				var reportNameAutoCompleter = me.getReportNameAutoCompleter();
				var clientAutoCompleter = me.getClientAutoCompleter();
				me.entityType = entityType;
				if(entityType === 'BANK'){
					me.hideClientPanel();
					
					if(!Ext.isEmpty(reportNameAutoCompleter))
					{
						reportNameAutoCompleter.cfgExtraParams = [
									   {
											key : '$filtercode1',
											value : filter.repOrDwnld
										},
										{
											key : '$filtercode2',
											value : 'Y'
			...
			getPreferencesToSave : function( localSave )
			{
				...
				var groupInfo = null, subGroupInfo = null, strModule = null, filter = me
					.getBankPreGeneratedReportFilterViewRef();
				var state = null;
				if( groupView )
				{
			...
			{
				var me = this, filter = me.getBankPreGeneratedReportFilterViewRef();
				data = null;
			...
			doHandleGroupActions : function( strAction, grid, arrSelectedRecords, strActionType )
			{
				...
				{
					strUrl = 'loadBankPreGeneratedReportWidgetsData/submit.srvc?';
				}
				else if( strAction == 'reportCenterDiscard' )
				{
					strUrl = 'loadBankPreGeneratedReportWidgetsData/discard.srvc?';
				}
				else if( strAction == 'reportCenterEnable' )
				{
					strUrl = 'loadBankPreGeneratedReportWidgetsData/enable.srvc?';
				}
				else if( strAction == 'reportCenterDisable' )
				{
					strUrl = 'loadBankPreGeneratedReportWidgetsData/disable.srvc?';
			...
			addFavoriteRep : function( reportCode, wdgt )
			{
				...
				Ext.Ajax.request(
				{
					url : 'userpreferences/bankPreGeneratedReport/preferredReports.srvc',
					method : 'POST',
			...
			{
				var me = this;
				var filterView = me.getBankPreGeneratedReportFilterViewRef();
			...
			postDoHandleGroupTabChange : function( data, args, isSuccess )
			{
				var me = args.scope;
				var objGroupView = me.getGroupView();
				var objSummaryView = me.getBankPreGeneratedReportViewRef(), objPref = null, gridModel = null, intPgSize = null;
			...
			{
				var me = this, filter = me.getBankPreGeneratedReportFilterViewRef(), arrFilter = [];
				var data = null;
				var me = this, filter = me.getBankPreGeneratedReportFilterViewRef(), arrFilter = [];
				...
				if( data )
				{
					if( data[ 'sellerCode' ] )
						...
						{
							paramName : 'seller',
							paramValue1 : ( (data[ 'sellerCode' ] +",OWNER" )|| '' ).toUpperCase(),
							operatorValue : 'in',
							dataType : 'S'
						} );
					if( data[ 'clientCode' ] )
			...
			{
				var me = this, filter = me.getBankPreGeneratedReportFilterViewRef(), arrFilter = [],sellerCombo = me.getSellerCombo(),
				reportNameId = filter.down('AutoCompleter[itemId="reportNameId"]');
				Ext.create( 'Ext.tip.ToolTip',
				{
					...
					listeners :
					{
						'beforeshow' : function( tip )
						{
							var data = filter.getQuickFilterJSON();
							var financialInstitutionVal = data[ 'sellerCode' ];
							var clientVal = ( data[ 'clientDesc' ] || getLabel( 'all', 'ALL' ) );
							...
							var reportName = reportNameId.getRawValue() || getLabel('none','None');
							...
							if( sellerCombo && sellerCombo.isVisible() )
							{
								...
								+ repOrDwnldDesc + '<br/>' + getLabel( 'reportDescription', 'Report Description' ) + ' : '
											+ reportName + '<br/>' + getLabel( 'date', 'Date' ) + ' : ' +  me.dateFilterLabel + ' ( ' + me.getDateValueForToolTip() + ')');
							}
								else if (entityType == "BANK") 
								{
									tip.update( getLabel( 'financialInstitution', 'Financial Insitution' ) + ' : '
											+ financialInstitutionVal + '<br/>' + getLabel( 'repOrDwnld', 'Report or Upload' ) + ' : '
											+ repOrDwnldDesc + '<br/>' + getLabel( 'reportDescription', 'Report Description' ) + ' : '
											+ reportName + '<br/>' + getLabel( 'date', 'Date' ) + ' : ' +  me.dateFilterLabel + ' ( ' + me.getDateValueForToolTip() + ')');
								}
							...
							else
							{
								...
								tip.update( getLabel('grid.column.company', 'Company Name') + ' : '
									...
									tip.update(getLabel( 'repOrDwnld', 'Report or Upload' ) + ' : '
											+ repOrDwnldDesc + '<br/>' + getLabel( 'reportDescription', 'Report Description' ) + ' : '
											+ reportName + '<br/>' + getLabel( 'date', 'Date' ) + ' : ' +  me.dateFilterLabel + ' ( ' + me.getDateValueForToolTip() + ')');
								}
							}
			...
			getDateValueForToolTip : function()
			{
				var me = this ;
				var index = me.dateFilterVal;
				...
				if (index !== '7') { 
					if (index === '1' || index === '2' || index === '12') {
						if (index === '12') {
							...
							me.dateToolTipLbl = '' + '  ' + vFromDate;
						} else
							me.dateToolTipLbl = vFromDate;
					} else {
						me.dateToolTipLbl = vFromDate + " - " + vToDate;
					}
				}
				else
				{
			...
			submitRequest : function( str, record )
			{
				...
				if( str == 'addReport' )
				{
					...
					var bankPreGeneratedReportFilterViewRef = me.getBankPreGeneratedReportFilterViewRef();
					form.appendChild( me.createFormField( 'INPUT', 'HIDDEN', 'clientCode',
						bankPreGeneratedReportFilterViewRef.clientCode ) );
