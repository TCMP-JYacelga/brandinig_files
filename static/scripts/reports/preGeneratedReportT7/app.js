...
{
	name : 'GCP',
	appFolder : 'static/scripts/reports/preGeneratedReportT7/app',
	requires :
	[
		'Ext.ux.gcp.PreferencesHandler', 'Ext.ux.gcp.GroupView', 'GCP.view.PreGeneratedReportView'
	],
	controllers :
	[
...
function resizeContentPanel()
{
	if( !Ext.isEmpty( objPreGeneratedReportView ) )
	{
		...
		var filterButton=objPreGeneratedReportView.down('button[itemId="filterButton"]');
